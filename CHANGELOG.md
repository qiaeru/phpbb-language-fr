...
- The language pack is now compatible with [phpBB 3.2.6](https://download.phpbb.com/pub/release/3.2/3.2.6/) and [phpBB 3.2.7](https://download.phpbb.com/pub/release/3.2/3.2.7/).
