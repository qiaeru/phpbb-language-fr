...
$lang = array_merge($lang, [
	...
	'ADD_ATTACHMENT_EXPLAIN'   => 'Pour insérer un ou plusieurs fichiers, renseignez les informations ci-dessous.',
	...
	'ATTACH_QUOTA_REACHED'     => 'Le quota de pièces jointes du forum a été atteint.',
	'ATTACH_SIG'               => 'Insérer une signature (personnalisable dans le panneau de contrôle utilisateur)',

	'BBCODE_A_HELP'        => 'Insérer une pièce jointe dans le texte : [attachment=]nomdufichier.ext[/attachment]',
	...
	'BBCODE_LISTITEM_HELP' => 'Élément d’une liste : [*]texte',
	...
	'CANNOT_DELETE_REPLIED'   => 'Vous ne pouvez pas supprimer un message ayant reçu une ou plusieurs réponses.',
	'CANNOT_EDIT_POST_LOCKED' => 'Le message a été verrouillé, vous ne pouvez plus le modifier.',
	'CANNOT_EDIT_TIME'        => 'Vous ne pouvez plus modifier ni supprimer ce message.',
	...
	'DISALLOWED_CONTENT'                => 'L’import a été refusé : le fichier a été identifié comme potentiellement malveillant.',
	...
	'LOAD_DRAFT_EXPLAIN'        => 'Sélectionnez ici le brouillon que vous souhaitez continuer à rédiger. Votre message actuel sera annulé et son contenu supprimé. Vous pouvez consulter, modifier et supprimer vos brouillons depuis le panneau de contrôle utilisateur.',
	'LOGIN_EXPLAIN_BUMP'        => 'Vous devez vous connecter pour remonter les sujets de ce forum.',
	'LOGIN_EXPLAIN_DELETE'      => 'Vous devez vous connecter pour supprimer définitivement les messages de ce forum.',
	'LOGIN_EXPLAIN_SOFT_DELETE' => 'Vous devez vous connecter pour supprimer les messages de ce forum.',
	'LOGIN_EXPLAIN_POST'        => 'Vous devez vous connecter pour publier des messages dans ce forum.',
	'LOGIN_EXPLAIN_QUOTE'       => 'Vous devez vous connecter pour citer les messages de ce forum.',
	'LOGIN_EXPLAIN_REPLY'       => 'Vous devez vous connecter pour répondre aux sujets de ce forum.',

	'MAX_ATTACHMENT_FILESIZE'   => 'Taille maximale des fichiers par pièce jointe : %s.',
	'MAX_FONT_SIZE_EXCEEDED'    => 'Vous ne pouvez utiliser que les polices dont la taille ne dépasse pas %d.',
	...
	'MESSAGE_BODY_EXPLAIN' => [
		...
		1 => 'Saisissez votre message ici. Il ne doit pas contenir plus de <strong>%d</strong> caractère.',
		2 => 'Saisissez votre message ici. Il ne doit pas contenir plus de <strong>%d</strong> caractères.',
	],
	...
	'NO_POST'                => 'Le message recherché est introuvable.',
	...
	'PLACE_INLINE'             => 'Insérer dans le texte',
	...
	'POLL_TITLE_COMP_TOO_LONG' => 'Le titre du sondage est trop long une fois analysé. Retirez des BBCodes ou des émoticônes pour le raccourcir.',
	'POLL_VOTE_CHANGE'         => 'Autoriser la modification du vote',
	...
	'POST_EDITED_MOD'          => 'Le message a été modifié, mais il doit être approuvé par un modérateur avant d’être visible publiquement.',
	...
	'POST_REVIEW_EDIT_EXPLAIN' => 'Le message a été modifié par un autre utilisateur pendant que vous le modifiiez. Vous pouvez prévisualiser la version actuelle et ajuster vos modifications.',
	'POST_REVIEW_EXPLAIN'      => 'Au moins un nouveau message a été publié dans ce sujet. Vous pouvez consulter votre message en surbrillance.',
	'POST_STORED'              => 'Le message a été publié.',
	'POST_STORED_MOD'          => 'Le message a été envoyé, mais il doit être approuvé par un modérateur avant d’être visible publiquement.',
	...
	'STICK_TOPIC_FOR_EXPLAIN'    => 'Laissez cette valeur à 0 si vous ne souhaitez pas que la note, l’annonce ou l’annonce générale expire et redevienne un sujet normal. Notez que le nombre de jours est relatif à la date de publication du message.',
	...
	'TOO_MANY_POLL_OPTIONS' => 'Vous avez saisi trop d’options de sondage.',
	...
	'URL_INVALID'                    => 'Le lien est invalide.',
	'URL_NOT_FOUND'                  => 'Le fichier est introuvable.',
	'URL_IS_OFF'                     => 'La balise [url] est <em>désactivée</em>',
	'URL_IS_ON'                      => 'La balise [url] est <em>activée</em>',
	'USER_CANNOT_BUMP'               => 'Vous n’êtes pas autorisé à remonter les sujets de ce forum.',
	'USER_CANNOT_DELETE'             => 'Vous n’êtes pas autorisé à supprimer les messages de ce forum.',
	'USER_CANNOT_EDIT'               => 'Vous n’êtes pas autorisé à modifier les messages de ce forum.',
	'USER_CANNOT_REPLY'              => 'Vous n’êtes pas autorisé à répondre aux messages de ce forum.',
	'USER_CANNOT_FORUM_POST'         => 'Ce type de forum ne permet pas de publier des messages.',

	'VIEW_MESSAGE'         => '%sConsulter le message%s',
	'VIEW_PRIVATE_MESSAGE' => '%sConsulter le message privé%s',

	'WRONG_FILESIZE' => 'Le fichier est trop volumineux : la taille maximale autorisée est de %1$d %2$s.',
