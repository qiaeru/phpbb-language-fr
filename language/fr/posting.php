...
$lang = array_merge($lang, [
	...
	'DISALLOWED_EXTENSION'              => 'L’extension « <em>%s</em> » n’est pas autorisée.',
	...
	'PHP_SIZE_NA'               => 'La taille de la pièce jointe est trop importante.<br />La taille maximale autorisée, située dans le fichier « <em>php.ini</em> », n’a pas pu être déterminée.',
	'PHP_SIZE_OVERRUN'          => 'La taille de la pièce jointe est trop importante, la taille maximale autorisée est de %1$d %2$s.<br />Veuillez noter que cette option est située dans le fichier « <em>php.ini</em> » et qu’elle ne peut pas être écrasée.',
	...
	'STICK_TOPIC_FOR_EXPLAIN'    => 'Laissez cette valeur à <strong>0</strong> si vous ne souhaitez pas que la note, l’annonce ou l’annonce générale expire et se transforme en sujet normal. Veuillez noter que le nombre de jours est relatif à la date de publication du message.',
