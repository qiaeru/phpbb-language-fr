...
$lang = array_merge($lang, [
	...
	'FIND_USERNAME_EXPLAIN' => 'Utilisez ce formulaire afin de rechercher des membres spécifiques. Vous n’avez pas besoin de remplir tous les champs. Pour utiliser partiellement une donnée, utilisez * comme joker. Lorsque vous saisissez une date, utilisez le format « <em>AAAA-MM-JJ</em> », comme par exemple « <em>2004-02-29</em> ». Utilisez les cases à cocher afin de sélectionner un ou plusieurs noms d’utilisateurs et cliquez sur le bouton « <em>Sélectionner la sélection</em> » afin de revenir au formulaire précédent.',
