...
$lang = array_merge($lang, [
	...
	'INTRODUCTION_BODY'  => 'Bienvenue sur phpBB 3.3 !<br /><br />phpBB® est le logiciel de forum de discussions libre et gratuit le plus populaire dans le monde. Il est l’aboutissement d’un développment qui a débuté en 2000. Tout comme ses versions précédentes, phpBB 3.3 est riche en fonctionnalités, facile d’accès et entièrement supporté par phpBB Limited. Il améliore considérablement ce qui a rendu phpBB 2.0 populaire et ajoute des fonctionnalités demandées qui manquaient aux versions antérieures. Nous espérons avoir répondu convenablement à vos attentes.<br /><br />Cet assistant vous guidera au cours de l’installation et la mise à jour du logiciel, ainsi que la conversion d’un logiciel de forum de discussions (dont phpBB 2.0) vers phpBB 3.3. Pour plus d’informations, veuillez consulter <a href="../docs/INSTALL.html">le guide d’installation</a> (en anglais).<br /><br />Si vous souhaitez vous renseigner sur la licence du logiciel ou en savoir plus sur l’obtention du support ainsi que de sa politique, veuillez sélectionner les options appropriées situées sur le menu latéral de gauche. Pour continuer, veuillez sélectionner l’onglet approprié situé ci-dessus.',

	// Support page
	'SUPPORT_TITLE' => 'Support',
	'SUPPORT_BODY'  => 'La dernière version stable de phpBB 3 vous permet de bénéficier d’un support complet et gratuit comprenant :</p><ul><li>l’installation</li><li>la configuration</li><li>les questions techniques</li><li>les problèmes en relation avec de potentiels bogues du logiciel</li><li>la mise à jour d’une version « Release Candidate » (RC) vers la dernière version stable</li><li>la conversion de phpBB 2.0 vers phpBB 3.3</li><li>la conversion d’un logiciel de forum de discussions vers phpBB 3.3 (veuillez consulter le <a href="https://www.phpbb.com/community/viewforum.php?f=486">forum relatif aux convertisseurs</a> (en anglais))</li></ul><p>Nous encourageons vivement les utilisateurs des versions « Beta » de phpBB 3.3 à procéder à une nouvelle installation vers la dernière version stable.</p><h2>Extensions et styles</h2><p>Concernant les problèmes relatifs aux extensions, veuillez publier vos demandes de support dans le <a href="https://www.phpbb.com/community/viewforum.php?f=451">forum relatif aux extensions</a> (en anglais).<br />Concernant les problèmes relatifs aux styles, aux modèles et aux thèmes, veuillez publier vos demandes de support dans le <a href="https://www.phpbb.com/community/viewforum.php?f=471">forum relatif aux styles</a> (en anglais).<br /><br />Si votre question est spécifique à une archive, veuillez publier directement votre demande dans le sujet dédié à cette archive.</p><h2>Obtenir de l’aide</h2><p><a href="https://www.phpbb.com/community/viewtopic.php?f=14&amp;t=571070">Le message de bienvenue de phpBB</a> (en anglais)<br /><a href="https://www.phpbb.com/support/">La section relative au support</a> (en anglais)<br /><a href="https://www.phpbb.com/support/docs/en/3.3/ug/quickstart/">Le guide de démarrage rapide</a> (en anglais)<br /><br />Si vous souhaitez être tenu au courant des dernières versions et nouveautés de notre logiciel, vous pouvez <a href="https://www.phpbb.com/support/">vous inscrire à notre liste de diffusion</a> (en anglais).<br /><br />',
...
$lang = array_merge($lang, [
	...
	'PHP_GETIMAGESIZE_SUPPORT_EXPLAIN' => 'La fonction getimagesize() de PHP est disponible.',
	...
	'PHP_JSON_SUPPORT_EXPLAIN'         => 'L’extension JSON de PHP est requise.',
	'PHP_XML_SUPPORT'                  => 'Support de PHP XML/DOM',
	'PHP_XML_SUPPORT_EXPLAIN'          => 'L’extension XML/DOM de PHP est requise.',
...
$lang = array_merge($lang, [
	...
	//
	// Form labels
	'UPGRADE_INSTRUCTIONS' => 'La version <strong>%1$s</strong>, incluant de nouvelles fonctionnalités, est disponible. Veuillez consulter <a href="%2$s" title="%2$s"><strong>l’annonce de sortie</strong></a> (en anglais) afin de vous renseigner sur les modifications apportées et consulter les instructions pour mettre à jour votre forum.',
...
$lang = array_merge($lang, [
	...
	'OLD_UPDATE_FILES'           => 'Les fichiers de mise à jour sont obsolètes. Les fichiers de mise à jour trouvés sont prévus pour la mise à jour de phpBB %1$s à phpBB %2$s alors que la dernière version de phpBB est la %3$s.',
	'INCOMPATIBLE_UPDATE_FILES'  => 'Les fichiers de mise à jour trouvés sont incompatibles avec la version actuellement installée. La version actuellement installée est la %1$s alors que le fichier de mise à jour est prévu pour la mise à jour de phpBB %2$s à phpBB %3$s.',
]);
...
$lang = array_merge($lang, [
	...
	'TABLE_PREFIX_SAME'    => 'Le préfixe de table doit être celui qui est utilisé par le logiciel que vous souhaitez convertir.<br />» Le préfixe de table qui était spécifié était %s.',
	'DEFAULT_PREFIX_IS'    => 'Le convertisseur n’a pas été en mesure de trouver de tables comportant ce préfixe. Veuillez vous assurer d’avoir correctement spécifié les informations sur le forum que vous souhaitez convertir. Le préfixe de table par défaut concernant %1$s est <strong>%2$s</strong>.',
