...
$lang = array_merge($lang, array(
	...
	'PHP_SETTINGS_EXPLAIN'             => '<strong>Obligatoire</strong> - vous devez utiliser la version 5.3.3 ou supérieure de PHP (PHP 7 n’est cependant pas supporté) afin de pouvoir installer phpBB. Si le <var>mode sécurisé</var> est affiché ci-dessous, cela signifie que votre installation PHP fonctionne sous ce mode. Cela imposera des limitations à l’administration à distance et à des fonctionnalités similaires.',
	...
	'PHP_VERSION_REQD'                 => 'Version de PHP : >= 5.3.3, < 7.0.0-dev',
