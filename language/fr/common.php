...
$lang = array_merge($lang, [
	...
	'AJAX_ERROR_TEXT_ABORT'                              => 'La requête a été annulée par l’utilisateur.',
	'AJAX_ERROR_TEXT_TIMEOUT'                            => 'Votre requête a expiré. Veuillez réessayer.',
	'AJAX_ERROR_TEXT_PARSERERROR'                        => 'Une erreur est survenue lors de votre requête et le serveur a renvoyé une réponse invalide.',
	'ALLOWED'                                            => 'Autorisé',
	...
	'AND'                                                => 'et',
	'ARE_WATCHING_FORUM'                                 => 'Vous êtes à présent abonné à ce forum. Vous recevrez une notification lorsqu’un nouveau sujet sera publié dans celui-ci.',
	'ARE_WATCHING_TOPIC'                                 => 'Vous êtes à présent abonné à ce sujet. Vous recevrez une notification lorsqu’un nouveau message sera publié dans celui-ci.',
	'ASCENDING'                                          => 'Croissant',
	'ATTACHMENTS'                                        => 'Pièces jointes',
	'ATTACHED_IMAGE_NOT_IMAGE'                           => 'L’image que vous avez essayé d’insérer est invalide.',
	'AUTHOR'                                             => 'Auteur',
	...
	'AVATAR_NO_TEMP_DIR'                                 => 'Le répertoire temporaire est introuvable ou ne peut pas être écrit.',
	...
	'BOARD_BAN_PERM'         => 'Vous avez été <strong>définitivement</strong> banni de ce forum.<br /><br />Pour plus d’informations, veuillez contacter un %2$sadministrateur du forum%3$s.',
	'BOARD_BAN_REASON'       => 'Raison du bannissement : <strong>%s</strong>',
	'BOARD_BAN_TIME'         => 'Vous avez été banni de ce forum jusqu’au <strong>%1$s</strong>.<br /><br />Pour plus d’informations, veuillez contacter un %2$sadministrateur du forum%3$s.',
	...
	'CONFIRM_CODE_EXPLAIN'  => 'Veuillez saisir le code tel qu’il apparaît dans l’image. Les lettres sont insensibles à la casse.',
	...
	'EXTENSION'                        => 'Extension',
	'EXTENSION_DISABLED'               => 'L’extension <strong>%s</strong> est désactivée.',
	...
	'FROM'                  => 'de',
	'FSOCK_DISABLED'        => 'L’opération a échoué car la fonction <var>fsockopen</var> est désactivée ou le serveur interrogé est introuvable.',
	...
	'IF'                       => 'Si',
	'IMAGE'                    => 'Image',
	'IMAGE_FILETYPE_INVALID'   => 'Le type d’image %d du standard MIME %s n’est pas supporté.',
	'IMAGE_FILETYPE_MISMATCH'  => 'Le type d’image ne correspond pas. L’extension %1$s était attendue alors que l’extension %2$s a été transférée.',
	'IN'                       => 'dans',
	'INACTIVE'                 => 'Inactif',
	...
	'INVALID_EMAIL_LOG'        => 'L’adresse de courriel <strong>%s</strong> est potentiellement invalide.',
	...
	'LOCK_POST_EXPLAIN'                        => 'Ne pourra plus être modifié',
	...
	'LOGIN_ERROR_OAUTH_SERVICE_DOES_NOT_EXIST' => 'Le service OAuth que vous souhaitez utiliser n’existe pas.',
	'LOGIN_ERROR_PASSWORD'                     => 'Vous avez spécifié un mot de passe incorrect. Veuillez vérifier votre mot de passe et réessayer. Si ce problème persiste, veuillez contacter un %sadministrateur du forum%s.',
	'LOGIN_ERROR_PASSWORD_CONVERT'             => 'Il n’a pas été possible de convertir votre mot de passe lors de la mise à jour du logiciel de ce forum de discussions. Veuillez %sdemander un nouveau mot de passe%s. Si ce problème persiste, veuillez contacter un %sadministrateur du forum%s.',
	'LOGIN_ERROR_USERNAME'                     => 'Vous avez spécifié un nom d’utilisateur incorrect. Veuillez vérifier votre nom d’utilisateur et réessayer. Si ce problème persiste, veuillez contacter un %sadministrateur du forum%s.',
	'LOGIN_FORUM'                              => 'Vous devez saisir le mot de passe de ce forum afin de consulter ou de publier des sujets et des messages.',
	...
	'NOT_WATCHING_FORUM'       => 'Vous n’êtes à présent plus abonné à ce forum. Vous ne recevrez plus de notification lorsqu’un nouveau sujet sera publié dans celui-ci.',
	'NOT_WATCHING_TOPIC'       => 'Vous n’êtes à présent plus abonné à ce sujet. Vous ne recevrez plus de notification lorsqu’un nouveau message sera publié dans celui-ci.',
	...
	'NO_AVATARS'                => 'Aucun avatar n’est actuellement disponible',
	...
	'NO_EMAIL_MESSAGE'          => 'Ce courriel n’a aucun contenu.',
	'NO_EMAIL_RESPONSE_CODE'    => 'Une erreur est survenue lors de la récupération des codes de réponse du serveur de messagerie électronique.',
	...
	'NO_GROUP_MEMBERS'          => 'Ce groupe d’utilisateurs n’a aucun membre.',
