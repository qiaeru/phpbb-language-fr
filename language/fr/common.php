...
$lang = array_merge($lang, [
	...
	'AVATAR_DISALLOWED_EXTENSION'                        => 'Ce fichier ne peut pas être affiché car l’extension « <em>%s</em> » n’est pas autorisée.',
	...
	'AVATAR_INVALID_FILENAME'                            => 'Le nom de fichier « <em>%s</em> » est invalide.',
	...
	'AVATAR_PHP_SIZE_NA'                                 => 'La taille de l’avatar est trop importante.<br />La taille maximale autorisée, située dans le fichier « <em>php.ini</em> », n’a pas pu être détectée.',
	'AVATAR_PHP_SIZE_OVERRUN'                            => 'La taille de l’avatar est trop importante. La taille maximale autorisée est de %1$d %2$s.<br />Veuillez noter que cette option est située dans le fichier « <em>php.ini</em> » et qu’elle ne peut pas être écrasée.',
	...
	'CANCEL'               => 'Annuler',
	'CANNOT_RENAME_FILE'   => 'Impossible de renommer « <em>%s</em> »',
	'CHANGE'               => 'Modifier',
	...
	'EXTENSION'                        => 'Extension',
	'EXTENSION_DISABLED'               => 'L’extension « <em>%s</em> » est désactivée.',
	'EXTENSION_DISABLED_AFTER_POSTING' => 'L’extension « <em>%s</em> » a été désactivée et ne peut plus être affichée.',
	'EXTENSION_DOES_NOT_EXIST'         => 'L’extension « <em>%s</em> » est introuvable.',
	...
	'FROM'                  => 'de',
	'FSOCK_DISABLED'        => 'L’opération a échoué car la fonction « <em>fsockopen</em> » est désactivée ou le serveur interrogé est introuvable.',
	...
	'IF'                       => 'Si',
	'IMAGE'                    => 'Image',
	'IMAGE_FILETYPE_INVALID'   => 'Le type d’image « <em>%d</em> » du standard MIME « <em>%s</em> » n’est pas pris en charge.',
	'IMAGE_FILETYPE_MISMATCH'  => 'Le type d’image ne correspond pas. L’extension « <em>%1$s</em> » était attendue mais l’extension « <em>%2$s</em> » a été transférée.',
	'IN'                       => 'dans',
	'INACTIVE'                 => 'Inactif',
	...
	'INVALID_EMAIL_LOG'        => 'L’adresse de courriel « <em>%s</em> » est potentiellement invalide.',
	...
	'MODULE_NOT_FIND'             => 'Le module « <em>%s</em> » est introuvable',
	'MODULE_FILE_INCORRECT_CLASS' => 'Le fichier du module « <em>%s</em> » ne contient pas la classe « <em>%s</em> »',
	'MONTH'                       => 'Mois',
	'MOVE'                        => 'Déplacer',
	...
	'NOTIFICATION_METHOD_INVALID'         => 'La méthode « <em>%s</em> » ne fait pas référence à une méthode de notification valide.',
	...
	'NOTIFICATION_TYPE_NOT_EXIST'      => 'Le type de notification « <em>%s</em> » est introuvable dans le système de fichiers.',
	...
	'REMOVE'                   => 'Supprimer',
	'REMOVE_INSTALL'           => 'Veuillez supprimer, déplacer ou renommer le répertoire « <em>install/</em> » de votre serveur. Seul le panneau de contrôle d’administration sera accessible tant que ce répertoire est présent.',
	'REPLIES'                  => 'Réponses',
	...
	'UNWATCH_FORUM_DETAILED'  => 'Êtes-vous sûr de vouloir vous désabonner du forum « <em>%s</em> » ?',
	'UNWATCH_TOPIC_CONFIRM'   => 'Êtes-vous sûr de vouloir vous désabonner de ce sujet ?',
	'UNWATCH_TOPIC_DETAILED'  => 'Êtes-vous sûr de vouloir vous désabonner du sujet « <em>%s</em> » ?',
	...
	'WATCH_FORUM_DETAILED' => 'Êtes-vous sûr de vouloir vous abonner au forum « <em>%s</em> » ?',
	'WATCH_TOPIC_CONFIRM'  => 'Êtes-vous sûr de vouloir vous abonner à ce sujet ?',
	'WATCH_TOPIC_DETAILED' => 'Êtes-vous sûr de vouloir vous abonner au sujet « <em>%s</em> » ?',
