...
$lang = array_merge($lang, array(
	...
	'AJAX_ERROR_TEXT_PARSERERROR'	=> 'La requête a échoué et le serveur a renvoyé une réponse invalide.',
	'ALLOWED'						=> 'Autorisé',
	...
	'AVATAR_DISALLOWED_CONTENT'		=> 'Le transfert a été interrompu car le fichier que vous avez transféré a été identifié comme un vecteur d’attaque possible.',
	...
	'BUTTON_PM_REPLY'		=> 'Envoyer une réponse',
	...
	'EMAIL_INVALID_EMAIL'				=> 'L’adresse de courrier électronique que vous avez spécifiée est invalide.',
	...
	'ERR_TEMPLATE_EVENT_LOCATION'		=> 'L’emplacement de l’événement template <em>[%s]</em> n’est pas formaté correctement.',
	'ERR_TEMPLATE_COMPILATION'		=> 'Le fichier n’a pas pu être compilé : %s',
	...
	'EXTENSION'							=> 'Extension',
	'EXTENSION_CONTROLLER_MISSING'		=> 'L’extension <strong>%s</strong> ne contient pas de classe de contrôle et ne peut donc pas être accessible par l’intermédiaire du front-end.',
	'EXTENSION_CLASS_WRONG_TYPE'		=> 'La classe de contrôle de l’extension <strong>%s</strong> est une instance de phpbb_extension_controller_interface.',
	...
	'NOTIFICATION_TOPIC'				=> '%1$s a publié le nouveau sujet « %2$s » dans le forum « %3$s ».',
	'NOTIFICATION_TOPIC_APPROVED'		=> 'Votre sujet « %2$s » dans le forum « %3$s » a été approuvé.',
	'NOTIFICATION_TOPIC_DISAPPROVED'	=> 'Votre sujet « %1$s » a été désapprouvé avec la raison suivante : « %2$s ».',
	...
	'NO_AVATAR_SELECTED'		=> 'Vous n’avez sélectionné aucun avatar.',
	...
	'NO_SUCH_SEARCH_MODULE'		=> 'Le module de recherche que vous avez spécifié n’existe pas.',
	...
	'POSTED_ON_DATE'		=> 'le',
	'POSTS'					=> 'Messages',
	'POSTS_UNAPPROVED'		=> 'Au moins un message n’a pas été approuvé dans ce sujet.',
	'POST_BY_AUTHOR'		=> 'par',
	...
	'SEND_EMAIL_USER'			=> 'Envoyer un courrier électronique à',				// Used as: {L_SEND_EMAIL_USER} {USERNAME} -> Email UserX
