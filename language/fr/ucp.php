...
$lang = array_merge($lang, [
	...
	'AVATAR_NOT_ALLOWED'             => 'Votre avatar ne peut pas être affiché car l’utilisation des avatars n’est pas autorisée par les administrateurs du forum.',
	'AVATAR_PAGE'                    => 'Page',
	'AVATAR_SELECT'                  => 'Sélectionnez votre avatar',
	'AVATAR_TYPE'                    => 'Type d’avatar',
	'AVATAR_TYPE_NOT_ALLOWED'        => 'Votre avatar actuel ne peut pas être affiché car ce type d’avatar n’est pas autorisé par les administrateurs du forum.',
	...
	'UCP_ADMIN_ACTIVATE'          => 'Veuillez noter que vous devez saisir une adresse de courriel correcte afin que votre compte soit activé. Un administrateur vérifiera votre compte et s’il est approuvé, vous recevrez un courriel à l’adresse de courriel que vous avez spécifiée.',
	...
	'UCP_PASSWORD_RESET_DISABLED'         => 'La réinitialisation de mots de passe a été désactivée. Si vous souhaitez obtenir de l’aide afin d’accéder à votre compte, veuillez contacter un %sadministrateur du forum%s',
	...
	'WRONG_ACTIVATION' => 'La clé d’activation que vous avez spécifiée est inconnue de la base de données.',
