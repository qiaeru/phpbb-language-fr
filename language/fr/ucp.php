...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_EMAIL_CHANGED_ADMIN'	=> 'Votre compte a été mis à jour. Cependant, un des administrateurs doit le réactiver car vous avez modifié votre adresse de courriel. Un courriel leur a été envoyé et vous serez informé de la réactivation de votre compte.',
	...
	'ACCOUNT_INACTIVE_ADMIN'		=> 'Votre compte a été créé. Cependant, un des administrateurs doit activer votre compte. Un courriel leur a été envoyé et vous serez informé de la réactivation de votre compte.',
	...
	'REMOVE_SELECTED_BOOKMARKS_CONFIRM'	=> 'Êtes-vous sûr de vouloir supprimer tous les sujets que vous avez sélectionnés de vos favoris ?',
	...
	'WATCHED_EXPLAIN'			=> 'La liste ci-dessous vous affiche les forums et les sujets auxquels vous êtes abonné. Vous recevrez une notification à chaque fois qu’un nouveau message est publié dans un de ces derniers. Si vous souhaitez vous désabonner d’un forum ou d’un sujet, sélectionnez-le et cliquez sur le bouton <em>Ne plus surveiller la sélection</em>.',
