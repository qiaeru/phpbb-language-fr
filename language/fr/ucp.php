...
$lang = array_merge($lang, [
	...
	'PRIVACY_POLICY' => 'Cette politique de confidentialité explique en détail comment « %1$s » et ses partenaires affiliés (désignés ci-après par « nous », « notre », « nos », « %1$s » et « %2$s ») et phpBB (désigné ci-après par « logiciel phpBB », « www.phpbb.com » et « phpBB Limited ») utilisent toutes les informations collectées lors des sessions d’utilisation de votre part (désignées ci-après par « vos informations »).<br />
	<br />
...
$lang = array_merge($lang, [
	...
	'BOARD_DATE_FORMAT_EXPLAIN' => 'La syntaxe qui est utilisée est identique à la fonction <a href="https://secure.php.net/manual/fr/function.date.php">date()</a> de PHP.',
	...
	'PERMISSIONS_TRANSFERRED'        => 'Les permissions de <strong>%s</strong> ont été transférées. Vous pouvez à présent parcourir le forum avec les permissions de cet utilisateur.<br />Veuillez noter que les permissions d’administration ne sont pas transférées. Vous pouvez restaurer vos permissions à tout moment.',
