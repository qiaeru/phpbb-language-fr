...
$lang = array_merge($lang, array(
	...
	<br />
	Nos forums sont developpés par phpBB (désignés ici par « ils », « eux », « leur », « logiciel phpBB », « www.phpbb.com », « phpBB Limited », « équipes de phpBB ») qui est une solution de création de forums déclarée sous la « <a href="http://opensource.org/licenses/GPL-2.0">Licence Publique Générale GNU v2</a> » (désignée ici par « GPL ») et qui peut être téléchargée sur <a href="https://www.phpbb.com/">www.phpbb.com</a>. Le logiciel phpBB a pour seul but de faciliter les discussions sur internet, le phpBB Limited n’est en aucun cas responsable de la conduite et/ou du contenu que nous acceptons et/ou que nous n’acceptons pas. Si vous souhaitez obtenir plus d’informations concernant phpBB, nous vous invitons à consulter <a href="https://www.phpbb.com/">https://www.phpbb.com/</a>.<br />
	<br />
...
$lang = array_merge($lang, array(
	...
	'FIELD_INVALID_CHARS_ALPHA_PUNCTUATION'	=> 'Le champ « %s » contient des caractères incorrects. Seuls les lettres, les chiffres, les tirets bas, les tirets, les virgules et les points sont autorisés. De même, le premier caractère doit être une lettre de l’alphabet.',
