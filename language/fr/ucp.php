...
$lang = array_merge($lang, array(
	...
	'FIELD_INVALID_CHARS_ALPHA_DOTS'	=> 'Le champ « %s » contient des caractères incorrects. Seuls les lettres, les chiffres et les points sont autorisés.',
	...
	'FIELD_INVALID_CHARS_ALPHA_PUNCTUATION'	=> 'Le champ « %s » contient des caractères incorrects. Seuls les lettres, les chiffres, les tirets bas, les tirets, les virgules et les points sont autorisés. De plus, le premier caractère doit être une lettre.',
	'FIELD_INVALID_CHARS_ALPHA_SPACERS'	=> 'Le champ « %s » contient des caractères incorrects. Seuls les lettres, les chiffres, les espaces, les tirets bas, les crochets et les signes plus et moins sont autorisés.',
	'FIELD_INVALID_CHARS_ALPHA_UNDERSCORE'	=> 'Le champ « %s » contient des caractères incorrects. Seuls les lettres, les chiffres et les tirets bas sont autorisés.',
	'FIELD_INVALID_CHARS_LETTER_NUM_DOTS'	=> 'Le champ « %s » contient des caractères incorrects. Seuls les lettres, les chiffres et les points sont autorisés.',
	'FIELD_INVALID_CHARS_LETTER_NUM_ONLY'	=> 'Le champ « %s » contient des caractères incorrects. Seuls les lettres et les chiffres sont autorisés.',
	'FIELD_INVALID_CHARS_LETTER_NUM_PUNCTUATION'	=> 'Le champ « %s » contient des caractères incorrects. Seuls les lettres, les chiffres, les tirets bas, les tirets et les points sont autorisés. De plus, le premier caractère doit être une lettre.',
	'FIELD_INVALID_CHARS_LETTER_NUM_SPACERS'		=> 'Le champ « %s » contient des caractères incorrects. Seuls les lettres, les chiffres, les espaces, les tirets bas, les crochets et les signes plus et moins sont autorisés.',
	'FIELD_INVALID_CHARS_LETTER_NUM_UNDERSCORE'		=> 'Le champ « %s » contient des caractères incorrects. Seuls les lettres, les chiffres et les tirets bas sont autorisés.',
	...
	'USERNAME_ALPHA_ONLY_EXPLAIN'	=> 'Le nom d’utilisateur doit être compris entre %1$s et %2$s de long et ne doit contenir que des lettres et des chiffres.',
	'USERNAME_ALPHA_SPACERS_EXPLAIN'=> 'Le nom d’utilisateur doit être compris entre %1$s et %2$s de long et ne doit contenir que des lettres, des chiffres, des espaces, des tirets bas, des crochets et des signes plus et moins.',
	...
	'USERNAME_CHARS_ANY_EXPLAIN'	=> 'Doit être compris entre %1$s et %2$s de long.',
