...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_INACTIVE'               => 'Votre compte a été créé. Cependant, vous devez activer votre compte. Une clé d’activation a été envoyée sur l’adresse de courrier électronique que vous avez spécifiée. Veuillez consulter votre messagerie pour plus d’informations. Si vous n’avez pas reçu le courriel, assurez-vous que celui-ci n’est pas présent dans votre boîte de courriels indésirables. Selon le fournisseur de messagerie, il se peut également que la réception prenne un peu plus de temps.',
