...
$lang = array_merge($lang, [
	'TERMS_OF_USE_CONTENT' => 'En accédant à « %1$s » (ci-après dénommé « nous », « notre », « nos », « %1$s » et « %2$s »), vous acceptez d’être légalement lié par les conditions suivantes. Si vous n’acceptez pas d’être légalement lié par l’ensemble des conditions suivantes, veuillez ne pas accéder à « %1$s » ni l’utiliser. Nous pouvons modifier ces conditions à tout moment et nous nous efforcerons de vous informer de ces modifications. Il vous incombe toutefois de consulter régulièrement ce document, car votre utilisation continue de « %1$s » après l’apport de modifications vaut acceptation de votre part d’être légalement lié par les conditions mises à jour ou modifiées.
	<br><br>
	Nos forums sont propulsés par phpBB (ci-après « ils », « eux », « leur », « logiciel phpBB », « www.phpbb.com », « phpBB Limited » et « équipes phpBB »), une solution de forum publiée sous la « <a href="https://opensource.org/license/gpl-2-0">licence publique générale GNU v2</a> » (ci-après « GPL »), qui peut être téléchargée à partir de <a href="https://www.phpbb.com/">www.phpbb.com</a> (en anglais). Le logiciel phpBB ne fait que faciliter les discussions sur Internet ; phpBB Limited n’est pas responsable du contenu ou des comportements autorisés ou interdits sur ce site. Pour plus d’informations sur phpBB, veuillez consulter : <a href="https://www.phpbb.com/">https://www.phpbb.com/</a> (en anglais).
	<br><br>
	Vous vous engagez à ne publier aucun contenu injurieux, obscène, vulgaire, diffamatoire, haineux, menaçant, à caractère sexuel ou contraire à la loi, que ce soit en vertu de la législation de votre pays, de celle du pays où « %1$s » est hébergé ou du droit international. Tout manquement à cette règle peut entraîner votre exclusion immédiate et définitive du site, et nous nous réservons le droit d’en informer votre fournisseur d’accès à Internet si nous le jugeons nécessaire. L’adresse IP de toutes les publications est enregistrée afin de faciliter l’application de ces conditions.
	<br><br>
	Vous acceptez que « %1$s » se réserve le droit de supprimer, modifier, déplacer ou fermer tout sujet à tout moment, à sa seule discrétion. En tant qu’utilisateur, vous acceptez que toute information que vous saisissez puisse être stockée dans une base de données. Bien que ces informations ne soient pas divulguées à des tiers sans votre consentement, ni « %1$s » ni phpBB ne peuvent être tenus responsables de toute tentative de piratage susceptible d’entraîner la compromission des données.
	',

	'PRIVACY_POLICY' => 'La présente politique explique en détail comment « %1$s » et ses sociétés affiliées (ci-après « nous », « notre », « notre », « %1$s » et « %2$s ») et phpBB (ci-après « ils », « eux », « leur », « logiciel phpBB », « www.phpbb.com », « phpBB Limited » et « équipes phpBB ») utilisent les informations collectées lors de votre utilisation de ce site (ci-après « vos informations »).
	<br><br>
	Vos informations sont collectées de deux manières. Lorsque vous naviguez sur « %1$s », le logiciel phpBB crée plusieurs cookies. Les cookies sont de petits fichiers texte stockés dans les fichiers temporaires de votre navigateur web. Les deux premiers cookies contiennent un identifiant utilisateur (ci-après « user-id ») et un identifiant de session anonyme (ci-après « session-id »), tous deux attribués automatiquement par le logiciel phpBB. Un troisième cookie sera créé une fois que vous aurez consulté des sujets au sein de « %1$s ». Il stocke des informations sur les sujets que vous avez lus, améliorant ainsi votre expérience utilisateur.
	<br><br>
	Il se peut également que nous créions des cookies externes au logiciel phpBB pendant que vous naviguez sur « %1$s ». Ceux-ci ne sont pas concernés par le présent document, qui ne traite que des cookies créés par le logiciel phpBB.
	<br><br>
	La deuxième façon dont nous recueillons des informations consiste à utiliser les données que vous nous fournissez. Cela comprend, sans s’y limiter : les publications en tant qu’utilisateur anonyme (ci-après dénommées « publications anonymes »), l’inscription sur « %1$s » (ci-après dénommée « votre compte »), ainsi que les publications que vous soumettez après vous être inscrit et lorsque vous êtes connecté (ci-après dénommées « vos publications »).
	<br><br>
	Votre compte comprendra au minimum : un nom d’utilisateur unique (ci-après « votre nom d’utilisateur »), un mot de passe personnel utilisé pour vous connecter (ci-après « votre mot de passe »), une adresse de courriel valide (ci-après « votre adresse de courriel »). Les informations de votre compte sur « %1$s » sont protégées par les lois sur la protection des données applicables dans le pays qui nous héberge. Toute information autre que votre nom d’utilisateur, votre mot de passe et votre adresse de courriel qui vous est demandée lors de l’inscription peut être obligatoire ou facultative, à la discrétion de « %1$s ». Dans tous les cas, vous pouvez choisir quelles informations de votre compte sont affichées publiquement. Vous pouvez également choisir de recevoir ou non les courriels générés automatiquement par le logiciel phpBB.
	<br><br>
	Votre mot de passe est stocké sous forme de hachage à sens unique afin d’en garantir la sécurité. Nous vous recommandons toutefois de ne pas utiliser le même mot de passe sur plusieurs sites web. Votre mot de passe est la clé d’accès à votre compte sur « %1$s », veillez donc à le conserver en lieu sûr. En aucun cas, une personne affiliée à « %1$s », à phpBB ou à un tiers ne vous demandera légitimement votre mot de passe. Si vous oubliez votre mot de passe, vous pouvez utiliser la fonctionnalité « J’ai oublié mon mot de passe » fournie par le logiciel phpBB. Ce processus vous demande de saisir votre nom d’utilisateur et votre adresse de courriel, après quoi le logiciel phpBB générera un nouveau mot de passe pour vous permettre de retrouver l’accès à votre compte.
	',
]);
