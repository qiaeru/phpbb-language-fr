...
$lang = array_merge($lang, [
	...
	'MIGRATION_EXCEPTION_ERROR'       => 'La requête a échoué et une exception a été levée. Les modifications effectuées avant que l’erreur ne survienne ont été annulées au mieux, mais vérifiez que votre forum fonctionne correctement.',
	...
	'MIGRATION_REVERT_DATA_DONE'          => 'Données annulées : %1$s ; durée : %2$.2f secondes',
	'MIGRATION_REVERT_DATA_IN_PROGRESS'   => 'Annulation des données : %1$s ; durée : %2$.2f secondes',
	'MIGRATION_REVERT_DATA_RUNNING'       => 'Annulation des données : %s.',
	'MIGRATION_REVERT_SCHEMA_DONE'        => 'Schéma annulé : %1$s ; durée : %2$.2f secondes',
	'MIGRATION_REVERT_SCHEMA_IN_PROGRESS' => 'Annulation du schéma : %1$s ; durée : %2$.2f secondes',
	'MIGRATION_REVERT_SCHEMA_RUNNING'     => 'Annulation du schéma : %s.',
	...
	'MIGRATION_INVALID_DATA_MISSING_STEP'        => 'Une migration n’est pas valide. Un appel valide à une étape de migration est manquant dans une instruction d’aide « IF ».',
