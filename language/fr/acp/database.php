...
$lang = array_merge($lang, [
	...
	'ACP_RESTORE_EXPLAIN' => 'Cette opération effectuera une restauration complète de toutes les tables de phpBB à partir d’un fichier de sauvegarde. Si votre serveur est compatible avec cette fonctionnalité, vous pouvez utiliser un fichier texte compressé au format GZip ou BZip2 qui sera automatiquement décompressé. <strong>Attention</strong> : cette opération remplacera toutes les données existantes. La restauration peut durer un certain temps. Ne quittez pas cette page tant qu’elle n’est pas terminée. Les sauvegardes sont stockées dans le répertoire « store/ » et sont supposées être générées par l’outil de sauvegarde présent par défaut dans le logiciel phpBB. Il est possible que la restauration des bases de données qui n’ont pas été sauvegardées avec cet outil ne fonctionne pas.',

	'BACKUP_DELETE'        => 'Le fichier de sauvegarde a été supprimé.',
	'BACKUP_INVALID'       => 'Le fichier de sauvegarde sélectionné est invalide.',
	'BACKUP_NOT_SUPPORTED' => 'Le fichier de sauvegarde sélectionné n’est pas pris en charge.',
	...
	'FILE_WRITE_FAIL' => 'Le répertoire de stockage est en lecture seule. Modifiez ses droits pour autoriser l’écriture par votre serveur.',
	...
	'RESTORE_SUCCESS'         => 'La base de données a été restaurée.<br><br>Votre forum est désormais dans l’état de la dernière sauvegarde.',
	...
	'TABLE_SELECT_ERROR' => 'Sélectionnez au moins une table.',
]);
