...
$lang = array_merge($lang, [
	...
	'COMPOSER_UNSUPPORTED_OPERATION'  => 'Opération non supportée pour le type de paquet « <em>%s</em> ».',
	...
	'COMPOSER_REPOSITORY_UNAVAILABLE' => 'Une erreur est survenue lors de la récupération du dépôt « <em>%s</em> ».',
	...
	'CRON_NO_SUCH_TASK' => 'La tâche cron « <em>%s</em> » est introuvable.',
	'CRON_NO_TASK'      => 'Aucune tâche cron ne doit être exécutée.',
	'CRON_NO_TASKS'     => 'Aucune tâche cron n’est disponible.',
	'CURRENT_VERSION'   => 'Version actuelle',

	'DEACTIVATE'               => 'Désactiver',
	'DIRECTORY_DOES_NOT_EXIST' => 'Le chemin « <em>%s</em> » que vous avez spécifié est introuvable.',
	'DIRECTORY_NOT_DIR'        => 'Le chemin « <em>%s</em> » que vous avez spécifié n’est pas un répertoire.',
	'DIRECTORY_NOT_WRITABLE'   => 'Le répertoire du chemin « <em>%s</em> » que vous avez spécifié est en lecture seule.',
	'DISABLE'                  => 'Désactiver',
	...
	'SETTING_TOO_LOW'   => 'La valeur que vous avez spécifiée concernant « <em>%1$s</em> » est trop faible. Cette valeur doit être supérieure ou égale à %2$d.',
	'SETTING_TOO_BIG'   => 'La valeur que vous avez spécifiée concernant « <em>%1$s</em> » est trop élevée. Cette valeur doit être inférieure ou égale à %2$d.',
	'SETTING_TOO_LONG'  => 'La valeur que vous avez spécifiée concernant « <em>%1$s</em> » est trop longue. Cette valeur doit être inférieure ou égale à %2$d.',
	'SETTING_TOO_SHORT' => 'La valeur que vous avez spécifiée concernant « <em>%1$s</em> » est trop courte. Cette valeur doit être supérieure ou égale à %2$d.',
...
$lang = array_merge($lang, [
	...
	'NO_SEARCH_INDEX' => 'La méthode d’indexation de la recherche sélectionnée n’est pas associée à un index de recherche.<br />Veuillez créer l’index associé à « <em>%1$s</em> » dans la section %2$sIndex de recherche%3$s.',
...
$lang = array_merge($lang, [
	...
	'LOG_DELETE_POST'         => '<strong>Suppression du message « <em>%1$s</em> » publié par %2$s en spécifiant une raison</strong><br />» %3$s',
	'LOG_DELETE_SHADOW_TOPIC' => '<strong>Suppression d’une redirection de sujet</strong><br />» %s',
	'LOG_DELETE_TOPIC'        => '<strong>Suppression du sujet « <em>%1$s</em> » publié par %2$s en spécifiant une raison</strong><br />» %3$s',
	...
	'LOG_POST_DISAPPROVED'    => '<strong>Désapprobation du message « <em>%1$s</em> » publié par %3$s en spécifiant une raison</strong><br />» %2$s',
	'LOG_POST_EDITED'         => '<strong>Modification du message « <em>%1$s</em> » publié par %2$s en spécifiant une raison</strong><br />» %3$s',
	...
	'LOG_RESTORE_TOPIC'       => '<strong>Restauration du sujet « <em>%1$s</em> » publié par</strong><br />» %2$s',
	'LOG_SOFTDELETE_POST'     => '<strong>Suppression du message « <em>%1$s</em> » publié par %2$s en spécifiant une raison</strong><br />» %3$s',
	'LOG_SOFTDELETE_TOPIC'    => '<strong>Suppression du sujet « <em>%1$s</em> » publié par %2$s en spécifiant une raison</strong><br />» %3$s',
	...
	'LOG_TOPIC_DISAPPROVED'  => '<strong>Désapprobation du sujet « <em>%1$s</em> » publié par %3$s en spécifiant une raison</strong><br />%2$s',
	...
	'LOG_GROUP_DEFAULTS' => '<strong>Le groupe « <em>%1$s</em> » a été défini comme groupe par défaut pour les membres</strong><br />» %2$s',
	...
	'LOG_USERS_PENDING'  => '<strong>Un ou plusieurs utilisateurs ont demandé à rejoindre le groupe d’utilisateurs « <em>%1$s</em> » et attendent d’être approuvés</strong><br />» %2$s',
	...
	'LOG_MCP_CHANGE_POSTER' => '<strong>Modification de l’auteur du sujet « <em>%1$s</em> »</strong><br />» de %2$s vers %3$s',
	...
	'LOG_USER_MOVE_POSTS'   => '<strong>Déplacement des messages d’un utilisateur</strong><br />» messages de %1$s vers le forum « <em>%2$s</em> »',
	...
	'LOG_USER_UPDATE_EMAIL' => '<strong>Modification de l’adresse de courriel de l’utilisateur %1$s</strong><br />» de « <em>%2$s</em> » à « <em>%3$s</em> »',
	'LOG_USER_UPDATE_NAME'  => '<strong>Modification d’un nom d’utilisateur</strong><br />» de « <em>%1$s</em> » à « <em>%2$s</em> »',
