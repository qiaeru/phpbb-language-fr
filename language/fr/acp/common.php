...
$lang = array_merge($lang, [
	...
	'ACP_LOGGING'        => 'Journalisation',

	'ACP_MAIN' => 'Accueil du PCA',

	'ACP_MANAGE_ATTACHMENTS'         => 'Gérer les pièces jointes',
	'ACP_MANAGE_ATTACHMENTS_EXPLAIN' => 'Depuis cette page, vous pouvez lister et supprimer les fichiers joints aux messages et aux messages privés.',
	...
	'ACP_SUBMIT_CHANGES' => 'Enregistrer les modifications',
...
$lang = array_merge($lang, [
	...
	'NO_SEARCH_INDEX' => 'La méthode d’indexation de la recherche sélectionnée n’est associée à aucun index. Créez l’index associé à « %1$s » dans la section « %2$sIndexation de la recherche%3$s ».',
	...
	'RESET_ONLINE'                => 'Réinitialiser le record d’utilisateurs en ligne simultanément',
	'RESET_ONLINE_CONFIRM'        => 'Êtes-vous sûr de vouloir réinitialiser le record d’utilisateurs en ligne simultanément ?',
	'RESET_ONLINE_SUCCESS'        => 'Le record d’utilisateurs en ligne simultanément a été réinitialisé.',
	...
	'RESYNC_POST_MARKING_EXPLAIN' => 'Le pointage de tous les sujets sera d’abord effacé, puis seuls les sujets actifs des six derniers mois seront de nouveau pointés.',
	...
	'VALUE'                        => 'Valeur',
	'VERSIONCHECK_FAIL'            => 'La récupération des informations sur la dernière version a échoué.',
...
$lang = array_merge($lang, [
	...
	'LOG_ACL_ADD_USER_LOCAL_F_'  => '<strong>Ajout ou modification de l’accès des utilisateurs au forum</strong> %1$s<br>» %2$s',
	'LOG_ACL_ADD_USER_LOCAL_M_'  => '<strong>Ajout ou modification de l’accès des modérateurs au forum</strong> %1$s<br>» %2$s',
	'LOG_ACL_ADD_GROUP_LOCAL_F_' => '<strong>Ajout ou modification de l’accès des groupes d’utilisateurs au forum</strong> %1$s<br>» %2$s',
	'LOG_ACL_ADD_GROUP_LOCAL_M_' => '<strong>Ajout ou modification de l’accès des groupes de modérateurs au forum</strong> %1$s<br>» %2$s',
	...
	'LOG_ACL_DEL_FORUM_LOCAL_F_'  => '<strong>Suppression des permissions d’utilisateurs ou de groupes d’utilisateurs sur le forum</strong> %1$s<br>» %2$s',
	...
	'LOG_BAN_EXCLUDE_USER'  => '<strong>Exclusion d’un nom d’utilisateur du bannissement</strong> avec la raison « %1$s »<br>» %2$s',
	...
	'LOG_BBCODE_CONFIGURATION_ERROR' => '<strong>La configuration du BBCode a échoué</strong> : %1$s<br>» %2$s',
	...
	'LOG_DELETE_POST'         => '<strong>Suppression définitive du message « %1$s » publié par %2$s pour la raison suivante</strong><br>» %3$s',
	'LOG_DELETE_SHADOW_TOPIC' => '<strong>Suppression d’une redirection de sujet</strong><br>» %s',
	'LOG_DELETE_TOPIC'        => '<strong>Suppression définitive du sujet « %1$s » publié par %2$s pour la raison suivante</strong><br>» %3$s',
	...
	'LOG_POST_DISAPPROVED'    => '<strong>Refus du message « %1$s » publié par %3$s pour la raison suivante</strong><br>» %2$s',
	'LOG_POST_EDITED'         => '<strong>Modification du message « %1$s » publié par %2$s pour la raison suivante</strong><br>» %3$s',
	...
	'LOG_SOFTDELETE_POST'     => '<strong>Suppression du message « %1$s » publié par %2$s pour la raison suivante</strong><br>» %3$s',
	'LOG_SOFTDELETE_TOPIC'    => '<strong>Suppression du sujet « %1$s » publié par %2$s pour la raison suivante</strong><br>» %3$s',
	...
	'LOG_TOPIC_DISAPPROVED'  => '<strong>Refus du sujet « %1$s » publié par %3$s pour la raison suivante</strong><br>» %2$s',
	...
	'LOG_GROUP_REMOVE'   => '<strong>Retrait de membres du groupe d’utilisateurs</strong> %1$s<br>» %2$s',
	...
	'LOG_IMAGE_GENERATION_ERROR' => '<strong>La création d’une image a échoué</strong><br>» Erreur dans %1$s sur la ligne %2$s : %3$s',
	...
	'LOG_INSTALL_CONVERTED' => '<strong>Conversion de %1$s vers phpBB %2$s</strong>',
	'LOG_INSTALL_INSTALLED' => '<strong>Installation de phpBB %s</strong>',

	'LOG_IP_BROWSER_FORWARDED_CHECK' => '<strong>Échec de la vérification de l’adresse IP, du navigateur ou du « X_FORWARDED_FOR » de la session</strong><br>» L’adresse IP de l’utilisateur « %1$s » a été comparée à l’adresse IP de la session « %2$s », la chaîne du navigateur de l’utilisateur « %3$s » à celle de la session « %4$s », et la chaîne X_FORWARDED_FOR de l’utilisateur « %5$s » à celle de la session « %6$s ».',
	...
	'LOG_MODULE_MOVE_DOWN' => '<strong>Déplacement d’un module vers le bas</strong><br>» %1$s en dessous de %2$s',
	'LOG_MODULE_MOVE_UP'   => '<strong>Déplacement d’un module vers le haut</strong><br>» %1$s au-dessus de %2$s',
	...
	'LOG_PLUPLOAD_TIDY_FAILED' => '<strong>Le nettoyage a échoué car il est impossible d’ouvrir %1$s. Vérifiez les permissions.</strong><br>Exception : %2$s<br>Trace : %3$s',
	...
	'LOG_REFERER_INVALID'     => '<strong>Échec de la validation du référent</strong><br>»Le référent était « %1$s ». La requête a été rejetée et la session a été interrompue.',
	...
	'LOG_RESYNC_FILES_STATS'  => '<strong>Resynchronisation des statistiques des fichiers</strong>',
	'LOG_RESYNC_POSTCOUNTS'   => '<strong>Resynchronisation du compteur de messages des utilisateurs</strong>',
