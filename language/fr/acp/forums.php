...
$lang = array_merge($lang, [
	...
	'COPY_PERMISSIONS_EDIT_EXPLAIN' => 'Si vous copiez des permissions, ce forum détiendra les mêmes permissions que celles du forum que vous avez sélectionné. Toutes les permissions définies antérieurement dans ce forum seront écrasées et remplacées par les permissions du forum sélectionné. Si vous ne sélectionnez aucun forum, les permissions actuelles seront conservées.',
	...
	'ENABLE_QUICK_REPLY_EXPLAIN' => 'Si cette option est activée, les utilisateurs pourront utiliser la réponse rapide sur ce forum. Ce Paramètre n’est pas pris en compte si la réponse rapide a été désactivée dans les Paramètres de la publication. Le champ de la réponse rapide ne sera visible qu’aux utilisateurs autorisés à publier dans ce forum.',
	...
	'FORUM_AUTO_PRUNE_EXPLAIN'       => 'Si cette option est activée, les sujets de ce forum seront délestés selon les Paramètres de la fréquence et des intervalles du délestage automatique spécifiés ci-dessous.',
	...
	'FORUM_EDIT_EXPLAIN'             => 'Le formulaire ci-dessous vous permet de personnaliser le forum sélectionné. Veuillez noter que la modération et les Paramètres relatifs aux compteurs de messages sont disponibles depuis les permissions des forums aux utilisateurs et aux groupes d’utilisateurs.',
	...
	'FORUM_PRUNE_SHADOW_EXPLAIN'     => 'Les redirections de sujet seront supprimées du forum. Configurez ci-dessous les paramètres de fréquence et d’ancienneté.',
	...
	'FORUM_TOPICS_PAGE_EXPLAIN'      => 'Si cette valeur est autre que 0, elle écrasera le Paramètre par défaut du nombre de sujets par page.',
	...
	'NO_DESTINATION_FORUM'       => 'Aucun forum destiné à recevoir le contenu n’a été sélectionné.',
	...
	'NO_PERMISSION_FORUM_ADD'    => 'Vous n’avez pas l’autorisation d’ajouter des forums.',
	'NO_PERMISSION_FORUM_DELETE' => 'Vous n’avez pas l’autorisation de supprimer des forums.',

	'PARENT_IS_LINK_FORUM'    => 'Ce forum parent est un forum-lien et ne peut donc pas contenir d’autres forums. Veuillez sélectionner une catégorie ou un forum comme forum parent.',
