...
$lang = array_merge($lang, [
	...
	'COPY_PERMISSIONS_ADD_EXPLAIN'  => 'Une fois créé, le forum détiendra les mêmes permissions que celles du forum que vous avez sélectionné. Si vous ne sélectionnez aucun forum, le forum nouvellement créé ne sera pas visible jusqu’à que ses permissions soient réglées.',
	'COPY_PERMISSIONS_EDIT_EXPLAIN' => 'Si vous copiez des permissions, ce forum détiendra les mêmes permissions que celles du forum que vous avez sélectionné. Toutes les permissions réglées antérieurement dans ce forum seront écrasées et remplacées par les permissions du forum sélectionné. Si vous ne sélectionnez aucun forum, les permissions actuelles seront conservées.',
	...
	'FORUM_EDIT_EXPLAIN'             => 'Le formulaire ci-dessous vous permet de personnaliser le forum sélectionné. Veuillez noter que la modération et les réglages relatifs aux compteurs de messages sont disponibles depuis les permissions des forums aux utilisateurs et aux groupes d’utilisateurs.',
