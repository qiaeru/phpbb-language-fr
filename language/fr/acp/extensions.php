...
$lang = array_merge($lang, [
	...
	'EXTENSION_ALREADY_INSTALLED'              => 'L’extension « <em>%s</em> » a déjà été installée.',
	'EXTENSION_ALREADY_INSTALLED_MANUALLY'     => 'L’extension « <em>%s</em> » a déjà été installée manuellement.',
	'EXTENSION_ALREADY_MANAGED'                => 'L’extension « <em>%s</em> » est déjà gérée.',
	'EXTENSION_CANNOT_MANAGE_FILESYSTEM_ERROR' => 'L’extension « <em>%s</em> » ne peut pas être gérée car les fichiers existants n’ont pas pu être supprimés du sytème de fichiers.',
	'EXTENSION_CANNOT_MANAGE_INSTALL_ERROR'    => 'L’extension « <em>%s</em> » n’a pas pu être installée. L’installation précédente de cette extension a été restaurée.',
	'EXTENSION_MANAGED_WITH_CLEAN_ERROR'       => 'L’extension « <em>%1$s</em> » a été installée mais une erreur est survenue et les anciens fichiers n’ont pas pu être supprimés. Vous devriez supprimer les fichiers %2$s manuellement.',
	'EXTENSION_MANAGED_WITH_ENABLE_ERROR'      => 'L’extension « <em>%s</em> » a été installée mais une erreur est survenue lors de son activation.',
	'EXTENSION_NOT_INSTALLED'                  => 'L’extension « <em>%s</em> » n’est pas installée.',
	...
	'EXTENSION_INVALID_LIST'   => 'L’extension « <em>%s</em> » est invalide.<br />%s<br /><br />',
	...
	'EXTENSION_INSTALL_EXPLAIN'  => '<ol>
			...
			<li>Décompressez et transférez l’extension dans le répertoire <samp>ext/</samp> de votre forum</li>
	...
	'EXTENSION_DELETE_DATA_CONFIRM'    => 'Êtes-vous sûr de vouloir supprimer les données de « <em>%s</em> » ?<br /><br />Cela supprimera toutes les données et la configuration de l’extension qui ne pourront pas être restaurés !',
	'EXTENSION_DISABLE_CONFIRM'        => 'Êtes-vous sûr de vouloir désactiver l’extension « <em>%s</em> » ?',
	'EXTENSION_ENABLE_CONFIRM'         => 'Êtes-vous sûr de vouloir activer l’extension « <em>%s</em> » ?',
	...
	'COMPOSER_REPOSITORIES_EXPLAIN' => 'Ajoute des liens aux dépôts de Composer des extensions à rechercher. Chaque dépôt doit être ajouté sur une nouvelle ligne. Les adresses doivent correspondrent à l’adresse de base du fichier « <em>packages.json</em> ».',
	'NO_EXTENSION_AVAILABLE'        => 'Aucune extension n’est disponible pour votre forum',

	'EXTENSION_MANAGED_SUCCESS' => 'L’extension « <em>%s</em> » va à présent être gérée automatiquement.',
	...
	'EXTENSIONS_COMPOSER_NOT_WRITABLE' => 'Pour utiliser la bibliothèque, les droits d’accès aux fichiers et aux répertoires devraient être modifiées pour écriture par votre serveur : « <em>ext/</em> », « <em>vendor-ext/</em> », « <em>composer-ext.json</em> » et « <em>composer-ext.lock</em> ».',
