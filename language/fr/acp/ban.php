...
$lang = array_merge($lang, [
	...
	'EMAIL_BAN_EXPLAIN'         => 'Vous pouvez bannir plusieurs adresses de courriel en les saisissant sur une nouvelle ligne. Pour utiliser des adresses partielles, utilisez le caractère « * » comme joker. Par exemple, « *@outlook.com », « *@*.domaine.tld », etc.',
	...
	'IP_BAN_EXPLAIN'         => 'Vous pouvez bannir plusieurs adresses IP ou noms d’hôtes en les saisissant sur une nouvelle ligne. Pour spécifier une plage d’adresses IP, séparez le début et la fin par un tiret « - » et pour spécifier un joker, utilisez le caractère « * ».',
