...
$lang = array_merge($lang, [
	...
	'TRACE_GROUP_NEVER_TOTAL_NEVER_LOCAL' => 'Cette permission de groupe concernant ce forum est configurée sur <strong>JAMAIS</strong> tout comme le résultat total. L’ancien résultat est donc conservé.',
	'TRACE_GROUP_NEVER_TOTAL_NO'          => 'Cette permission de groupe est configurée sur <strong>JAMAIS</strong> ce qui devient la nouvelle valeur totale car elle n’était pas encore définie (configurée sur <strong>NON</strong>).',
	'TRACE_GROUP_NEVER_TOTAL_NO_LOCAL'    => 'Cette permission de groupe concernant ce forum est configurée sur <strong>JAMAIS</strong> ce qui devient la nouvelle valeur totale car elle n’était pas encore définie (configurée sur <strong>NON</strong>).',
	'TRACE_GROUP_NEVER_TOTAL_YES'         => 'Cette permission de groupe est configurée sur <strong>JAMAIS</strong> ce qui remplace le total de <strong>OUI</strong> par <strong>JAMAIS</strong> concernant cet utilisateur.',
	'TRACE_GROUP_NEVER_TOTAL_YES_LOCAL'   => 'Cette permission de groupe concernant ce forum est configurée sur <strong>JAMAIS</strong> ce qui remplace le total de <strong>OUI</strong> par <strong>JAMAIS</strong> concernant cet utilisateur.',
	'TRACE_GROUP_NO'                      => 'La permission est configurée sur <strong>NON</strong> concernant ce groupe. L’ancienne valeur totale est donc conservée.',
	'TRACE_GROUP_NO_LOCAL'                => 'La permission est configurée sur <strong>NON</strong> concernant ce groupe dans ce forum. L’ancienne valeur totale est donc conservée.',
	'TRACE_GROUP_YES_TOTAL_NEVER'         => 'Cette permission de groupe est configurée sur <strong>OUI</strong> mais le total de <strong>JAMAIS</strong> ne peut pas être écrasé.',
	'TRACE_GROUP_YES_TOTAL_NEVER_LOCAL'   => 'Cette permission de groupe concernant ce forum est configurée sur <strong>OUI</strong> mais le total de <strong>JAMAIS</strong> ne peut pas être écrasé.',
	'TRACE_GROUP_YES_TOTAL_NO'            => 'Cette permission de groupe est configurée sur <strong>OUI</strong> ce qui devient la nouvelle valeur totale car elle n’était pas encore définie (configurée sur <strong>NON</strong>).',
	...
	'TRACE_USER_GLOBAL_NEVER_TOTAL_KEPT' => 'La permission indépendante de l’utilisateur dans ce forum est configurée sur <strong>JAMAIS</strong> ce qui n’influence pas la permission locale. %sSuivre la permission générale%s',

	'TRACE_USER_FOUNDER'                 => 'L’utilisateur est un fondateur. Les permissions d’administrateurs sont donc toujours définies sur <strong>OUI</strong>.',
	'TRACE_USER_KEPT'                    => 'La permission de l’utilisateur est configurée sur <strong>NON</strong>. L’ancienne valeur totale est donc conservée.',
	'TRACE_USER_KEPT_LOCAL'              => 'La permission de l’utilisateur concernant ce forum est configurée sur <strong>NON</strong>. L’ancienne valeur totale est donc conservée.',
	'TRACE_USER_NEVER_TOTAL_NEVER'       => 'La permission de l’utilisateur est configurée sur <strong>JAMAIS</strong> et la valeur totale est configurée sur <strong>JAMAIS</strong>. Il n’y a donc aucune modification.',
	'TRACE_USER_NEVER_TOTAL_NEVER_LOCAL' => 'La permission de l’utilisateur concernant ce forum est configurée sur <strong>JAMAIS</strong> et la valeur totale est configurée sur <strong>JAMAIS</strong>. Il n’y a donc aucune modification.',
	'TRACE_USER_NEVER_TOTAL_NO'          => 'La permission de l’utilisateur est configurée sur <strong>JAMAIS</strong> ce qui devient la valeur totale car elle était configurée sur <strong>NON</strong>.',
	'TRACE_USER_NEVER_TOTAL_NO_LOCAL'    => 'La permission de l’utilisateur concernant ce forum est configurée sur <strong>JAMAIS</strong> ce qui devient la valeur totale car elle était configurée sur <strong>NON</strong>.',
	'TRACE_USER_NEVER_TOTAL_YES'         => 'La permission de l’utilisateur est configurée sur <strong>JAMAIS</strong> et écrase la précédente permission <strong>OUI</strong>.',
	'TRACE_USER_NEVER_TOTAL_YES_LOCAL'   => 'La permission de l’utilisateur concernant ce forum est configurée sur <strong>JAMAIS</strong> et écrase la précédente permission <strong>OUI</strong>.',
	'TRACE_USER_NO_TOTAL_NO'             => 'La permission de l’utilisateur est configurée sur <strong>NON</strong> et la valeur totale était configurée sur NON, donc sur <strong>JAMAIS</strong> par défaut.',
	'TRACE_USER_NO_TOTAL_NO_LOCAL'       => 'La permission de l’utilisateur concernant ce forum est configurée sur <strong>NON</strong> et la valeur totale était configurée sur <strong>NON</strong>, donc sur <strong>JAMAIS</strong> par défaut.',
	'TRACE_USER_YES_TOTAL_NEVER'         => 'La permission de l’utilisateur est configurée sur <strong>OUI</strong> mais le total de <strong>JAMAIS</strong> ne peut pas être écrasé.',
	'TRACE_USER_YES_TOTAL_NEVER_LOCAL'   => 'La permission de l’utilisateur concernant ce forum est configurée sur <strong>OUI</strong> mais le total de <strong>JAMAIS</strong> ne peut pas être écrasé.',
	'TRACE_USER_YES_TOTAL_NO'            => 'La permission de l’utilisateur est configurée sur <strong>OUI</strong> ce qui devient la valeur totale car elle était configurée sur <strong>NON</strong>.',
	'TRACE_USER_YES_TOTAL_NO_LOCAL'      => 'La permission de l’utilisateur concernant ce forum est configurée sur <strong>OUI</strong> ce qui devient la valeur totale car elle était configurée sur <strong>NON</strong>.',
	'TRACE_USER_YES_TOTAL_YES'           => 'La permission de l’utilisateur est configurée sur <strong>OUI</strong> et la valeur totale est configurée sur <strong>OUI</strong>. Il n’y a donc aucune modification.',
	'TRACE_USER_YES_TOTAL_YES_LOCAL'     => 'La permission de l’utilisateur concernant ce forum est configurée sur <strong>OUI</strong> et la valeur totale est configurée sur <strong>OUI</strong>. Il n’y a donc aucune modification.',
	'TRACE_WHO'                          => 'Qui',
	'TRACE_TOTAL'                        => 'Total',
