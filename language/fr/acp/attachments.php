...
$lang = array_merge($lang, [
	...
	'ALLOW_PM_ATTACHMENTS'            => 'Autoriser l’import de pièces jointes dans les messages privés',
	...
	'ATTACH_QUOTA_EXPLAIN'            => 'La taille maximale de l’espace de stockage qui sera alloué à la totalité des pièces jointes importées sur le forum. Réglez cette valeur sur « 0 » si vous ne souhaitez pas limiter la taille de cet espace.',
	'ATTACH_TO_POST'                  => 'Joindre le fichier au message',

	'CAT_IMAGES'               => 'Images',
	'CHECK_CONTENT'            => 'Vérifier les pièces jointes',
	'CHECK_CONTENT_EXPLAIN'    => 'Certains navigateurs web peuvent attribuer un type MIME erroné aux fichiers importés. Cette option rejette les fichiers susceptibles de provoquer cette erreur.',
	...
	'DOWNLOAD_ADD_IPS_EXPLAIN'    => 'Saisissez chaque adresse IP et nom d’hôte sur une nouvelle ligne. Pour indiquer une plage d’adresses IP, séparez le début et la fin par un tiret « - » et utilisez un astérisque « * » comme métacaractère passe-partout.',
	...
	'DISPLAY_INLINED_EXPLAIN'     => 'Si cette option est désactivée, les images importées en pièces jointes s’affichent uniquement sous forme de lien.',
	...
	'EXCLUDE_ENTERED_IP'         => 'Activez cette option pour exclure l’adresse IP ou le nom d’hôte saisi.',
	...
	'MAX_IMAGE_SIZE_EXPLAIN'     => 'Les dimensions maximales des images jointes. phpBB peut tenter de redimensionner automatiquement les images avant leur import pour les adapter à ces dimensions maximales. Définissez les deux valeurs sur « 0 px × 0 px » pour désactiver la vérification des dimensions et le redimensionnement automatique.',
	'MAX_THUMB_WIDTH'            => 'Dimensions maximales des miniatures',
	...
	'NO_ATTACHMENTS'            => 'Aucune pièce jointe n’a été trouvée pour cette période.',
	'NO_EXT_GROUP'              => 'Aucun',
	...
	'NO_UPLOAD_DIR'             => 'Le répertoire d’import est introuvable.',
	'NO_WRITE_UPLOAD'           => 'Le répertoire d’import est en lecture seule. Modifiez ses droits pour autoriser l’écriture par votre serveur.',
	...
	'SECURE_EMPTY_REFERRER'          => 'Autoriser les téléchargements sans référent',
	'SECURE_EMPTY_REFERRER_EXPLAIN'  => 'Les téléchargements sécurisés sont basés sur les référents. Souhaitez-vous autoriser les téléchargements aux utilisateurs qui ne divulguent pas leur référent ?',
	...
	'SUCCESSFULLY_UPLOADED'          => 'Le fichier a bien été importé.',
	'SUCCESS_EXTENSION_GROUP_ADD'    => 'Le groupe d’extensions a été ajouté.',
	'SUCCESS_EXTENSION_GROUP_EDIT'   => 'Le groupe d’extensions a été mis à jour.',

	'UPLOADING_FILES'       => 'Import de fichiers',
	'UPLOADING_FILE_TO'     => 'Import du fichier « %1$s » au message numéro %2$d…',
	'UPLOAD_DENIED_FORUM'   => 'Vous ne pouvez pas importer de fichiers vers le forum « %s ».',
	'UPLOAD_DIR'            => 'Répertoire d’import',
	...
	'UPLOAD_ICON'           => 'Icône d’import',
	'UPLOAD_NOT_DIR'        => 'Le répertoire d’import est invalide.',
	'UPLOAD_POST_NOT_EXIST' => 'Le fichier « %1$s » ne peut pas être importé vers le message numéro %2$d car le message n’existe pas.',
]);
