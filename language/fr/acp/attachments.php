...
$lang = array_merge($lang, [
	...
	'ACP_MANAGE_EXTENSIONS_EXPLAIN'   => 'Depuis cette page, vous pouvez gérer les extensions des pièces jointes autorisées à être envoyées et téléchargées sur votre forum. Pour activer une extension, vous devez vous rendre sur le panneau de gestion des groupes d’extensions. Pour des raisons de sécurité, nous vous recommandons de ne pas autoriser les extensions de langages de programmation (telles que « php », « php3 », « php4 », « phtml », « pl », « cgi », « py », « rb », « asp », « aspx », etc.).',
	...
	'ATTACH_QUOTA_EXPLAIN'            => 'La taille maximale de l’espace de stockage qui sera alloué à la totalité des pièces jointes envoyées sur le forum. Réglez cette valeur sur « 0 » si vous ne souhaitez pas limiter la taille de cet espace.',
	...
	'IMAGE_LINK_SIZE_EXPLAIN'      => 'Les images envoyées en pièces jointes seront affichées comme des liens si elles dépassent les valeurs indiquées dans ces champs. Réglez ces deux valeurs sur « 0 » pour désactiver ce comportement.',
	'IMAGE_QUALITY'                => 'Qualité des images envoyées comme pièces jointes (format JPEG uniquement)',
	...
	'UPLOADING_FILE_TO'     => 'Envoi du fichier « %1$s » au message numéro %2$d…',
	'UPLOAD_DENIED_FORUM'   => 'Vous ne pouvez pas envoyer de fichiers vers le forum « %s ».',
	...
	'UPLOAD_POST_NOT_EXIST' => 'Le fichier « %1$s » ne peut pas être envoyé vers le message numéro %2$d car le message n’existe pas.',
]);
