...
$lang = array_merge($lang, array(
	...
	'GROUP_MESSAGE_LIMIT_EXPLAIN'	=> 'La limite des messages privés par boîte des utilisateurs sera écrasée par ce réglage. La valeur maximale de tous les groupes de l’utilisateur est utilisée afin de déterminer la valeur actuelle.<br />Réglez cette valeur sur 0 afin d’écraser le réglage de tous les utilisateurs de ce groupe par le réglage général du forum.',
	...
	'GROUP_MAX_RECIPIENTS_EXPLAIN'	=> 'Le nombre maximal de destinataires autorisés dans un message privé. La valeur maximale de tous les groupes de l’utilisateur est utilisée afin de déterminer la valeur actuelle.<br />Réglez cette valeur sur 0 afin d’écraser le réglage de tous les utilisateurs de ce groupe par le réglage général du forum.',
