...
$lang = array_merge($lang, [
	...
	'GROUP_EDIT_EXPLAIN'           => 'Vous pouvez éditer sur cette page un groupe d’utilisateurs déjà existant. Vous pouvez modifier son nom, sa description et son type (restreint, privé, etc.). Vous pouvez également modifier certains Paramètres comme la couleur, le rang, etc. Les modifications effectuées sur cette page écraseront les Paramètres individuels des utilisateurs. Veuillez noter que si les permissions des utilisateurs le permettent, les membres d’un groupe d’utilisateurs pourront outrepasser le Paramètre de l’avatar en sélectionnant eux-mêmes un avatar personnalisé.',
	...
	'GROUP_MESSAGE_LIMIT_EXPLAIN'  => 'La limite des messages privés par boîte des utilisateurs sera écrasée par ce Paramètre. La valeur maximale de tous les groupes de l’utilisateur est utilisée afin de déterminer la valeur actuelle.<br />Réglez cette valeur sur 0 afin d’écraser le Paramètre de tous les utilisateurs de ce groupe par le Paramètre général du forum.',
	...
	'GROUP_MAX_RECIPIENTS_EXPLAIN' => 'Le nombre maximal de destinataires autorisés dans un message privé. La valeur maximale de tous les groupes de l’utilisateur est utilisée afin de déterminer la valeur actuelle.<br />Réglez cette valeur sur 0 afin d’écraser le Paramètre de tous les utilisateurs de ce groupe par le Paramètre général du forum.',
	...
	'SPECIAL_GROUPS_EXPLAIN' => 'Les groupes prédéfinis sont des groupes spéciaux. Ils ne peuvent ni être supprimés, ni être directement modifiés. Cependant, vous pouvez gérer leurs membres et éditer certains de leurs Paramètres.',
	...
	'USER_DEF_GROUPS_EXPLAIN'    => 'Les groupes définis par un administrateur sont des groupes d’utilisateurs créés par vous-même ou par un autre administrateur du forum. Vous pouvez gérer leurs membres, éditer leurs Paramètres ou encore les supprimer.',
