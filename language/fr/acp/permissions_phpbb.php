...
$lang = array_merge($lang, array(
	'permission_cat'	=> array(
		...
		'polls'			=> 'Sondages',
		'post'			=> 'Message',
		'post_actions'	=> 'Opérations des messages',
		'posting'		=> 'Publication',
		'profile'		=> 'Profil',
		'settings'		=> 'Réglages',
		'topic_actions'	=> 'Opérations des sujets',
		'user_group'	=> 'Utilisateurs et groupes',
	),
...
$lang = array_merge($lang, array(
	...
	'acl_u_savedrafts'	=> array('lang' => 'Peut enregistrer des messages comme brouillons', 'cat' => 'post'),
	...
	'acl_u_pm_delete'	=> array('lang' => 'Peut supprimer les messages privés de ses boîtes', 'cat' => 'pm'),
	'acl_u_pm_forward'	=> array('lang' => 'Peut transférer les messages privés', 'cat' => 'pm'),
	'acl_u_pm_emailpm'	=> array('lang' => 'Peut envoyer les messages privés par courrier électronique', 'cat' => 'pm'),
	'acl_u_pm_printpm'	=> array('lang' => 'Peut imprimer les messages privés', 'cat' => 'pm'),
	'acl_u_pm_attach'	=> array('lang' => 'Peut transférer des pièces jointes dans ses messages privés', 'cat' => 'pm'),
	'acl_u_pm_download'	=> array('lang' => 'Peut télécharger les pièces jointes transférées à des messages privés', 'cat' => 'pm'),
	'acl_u_pm_bbcode'	=> array('lang' => 'Peut utiliser du BBCode dans les messages privés', 'cat' => 'pm'),
	...
	'acl_u_sendemail'	=> array('lang' => 'Peut envoyer des courriers électroniques', 'cat' => 'misc'),
...
$lang = array_merge($lang, array(
	...
	'acl_f_bbcode'		=> array('lang' => 'Peut utiliser du BBCode', 'cat' => 'content'),
	...
	'acl_f_email'		=> array('lang' => 'Peut envoyer les sujets par courrier électronique', 'cat' => 'actions'),

	'acl_f_search'		=> array('lang' => 'Peut effectuer des recherches sur le forum', 'cat' => 'misc'),
...
$lang = array_merge($lang, array(
	...
	'acl_m_info'	=> array('lang' => 'Peut consulter les informations sur les messages', 'cat' => 'misc'),
	'acl_m_warn'	=> array('lang' => 'Peut distribuer des avertissements<br /><em>Ce réglage n’est assigné que généralement.</em>', 'cat' => 'misc'), // This moderator setting is only global (and not local)
	'acl_m_ban'		=> array('lang' => 'Peut gérer les bannissements<br /><em>Ce réglage n’est assigné que généralement.</em>', 'cat' => 'misc'), // This moderator setting is only global (and not local)
));
...
$lang = array_merge($lang, array(
	...
	'acl_a_bbcode'		=> array('lang' => 'Peut définir les balises BBCodes', 'cat' => 'posting'),
	...
	'acl_a_language'	=> array('lang' => 'Peut gérer les traductions', 'cat' => 'misc'),
	'acl_a_email'		=> array('lang' => 'Peut envoyer des courriers électroniques de masse', 'cat' => 'misc'),
