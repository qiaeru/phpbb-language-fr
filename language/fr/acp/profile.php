...
$lang = array_merge($lang, array(
	...
	'REQUIRED_FIELD_EXPLAIN'	=> 'Les utilisateurs devront obligatoirement renseigner le champ de profil. Si l’affichage est désactivé sur la page d’inscription, le champ ne devra être renseigné que dans le cas où les utilisateurs éditent leur profil.',
	'ROWS'						=> 'Lignes',
	...
	'STEP_2_EXPLAIN_EDIT'			=> 'Vous pouvez modifier sur cette page les options spécifiques de votre champ de profil.<br /><strong>Veuillez noter que les modifications apportées n’affecteront pas les champs de profil déjà existants et complétés par vos utilisateurs.</strong>',
