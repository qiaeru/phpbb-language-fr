...
$lang = array_merge($lang, [
	...
	'DISPLAY_PROFILE_FIELD_EXPLAIN' => 'Le champ de profil est affiché à tous les emplacements autorisés par les paramètres de la charge. Désactivez cette option pour masquer le champ sur les pages des sujets, les profils et la liste des membres.',
	'DROPDOWN_ENTRIES_EXPLAIN'      => 'Saisissez vos options. Chaque option doit être sur une nouvelle ligne.',

	'EDIT_DROPDOWN_LANG_EXPLAIN' => 'Vous pourrez modifier les libellés et ajouter de nouvelles options à la fin plus tard. Évitez d’insérer de nouvelles options entre des options existantes ou d’en supprimer au milieu de la liste : cela pourrait attribuer une mauvaise option à vos utilisateurs. Si vous supprimez les dernières options, les utilisateurs qui les avaient choisies retrouveront l’option par défaut.',
	'EMPTY_FIELD_IDENT'          => 'L’identifiant du champ est vide.',
	...
	'FIELD_IDENT'               => 'Identifiant du champ',
	'FIELD_IDENT_ALREADY_EXIST' => 'Cet identifiant de champ existe déjà. Saisissez-en un autre.',
	...
	'FIELD_LENGTH'              => 'Largeur de la zone de saisie',
	...
	'LETTER_NUM_SPACERS'     => 'Lettres (avec ou sans accent), chiffres et séparateurs',
	...
	'TEXT_DEFAULT_VALUE_EXPLAIN' => 'Saisissez un texte ou une valeur affichée par défaut. Laissez vide pour ne rien afficher.',
	'TRANSLATE'                  => 'Traduire',
