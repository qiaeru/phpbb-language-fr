...
$lang = array_merge($lang, array(
	...
	'ACP_SEARCH_SETTINGS_EXPLAIN'			=> 'Vous pouvez définir sur cette page la méthode d’indexation de la recherche qui sera utilisée lors de l’indexation des messages et l’exécution des recherches. Vous pouvez régler différentes options qui peuvent influencer sur le nombre d’exécutions que ces actions demandent. Certains de ces réglages sont les mêmes que toutes les autres méthodes d’indexation du moteur de recherche.',
