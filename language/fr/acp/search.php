...
$lang = array_merge($lang, [
	'ACP_SEARCH_INDEX_EXPLAIN'    => 'Depuis cette page, vous pouvez gérer les index des méthodes d’indexation de la recherche. Le moteur de recherche n’utilise qu’une seule méthode à la fois ; supprimez les index inutilisés. Après modification de la plupart des paramètres de recherche (notamment le nombre minimal et maximal de caractères), recréez l’index pour qu’il les prenne en compte.',
	...
	'COMMON_WORD_THRESHOLD_EXPLAIN'   => 'Les mots contenus dans un pourcentage de messages supérieur à cette valeur seront considérés comme communs. Les mots communs sont ignorés des recherches. Réglez cette valeur sur « 0 » pour désactiver ce comportement. Ce seuil ne s’applique que si le forum compte plus de 100 messages. Pour que les mots communs soient reconsidérés, vous devez recréer l’index.',
	...
	'CONTINUE_INDEXING_EXPLAIN'       => 'Une indexation est en cours. Terminez-la ou annulez-la pour accéder à la page de l’index de recherche.',
	...
	'FULLTEXT_POSTGRES_VERSION_CHECK_EXPLAIN' => 'Cette méthode d’indexation nécessite PostgreSQL 8.3 ou une version plus récente.',
	...
	'FULLTEXT_SPHINX_DATA_PATH_EXPLAIN'         => 'Ce répertoire stockera les index et les fichiers d’historique. Créez-le en dehors des répertoires accessibles depuis le web et terminez le chemin par une barre oblique.',
	...
	'FULLTEXT_SPHINX_HOST_EXPLAIN'              => 'Hôte sur lequel le démon de recherche Sphinx (« searchd ») écoute. Si vous laissez ce champ vide, l’hôte par défaut (« localhost ») sera utilisé.',
	...
	'FULLTEXT_SPHINX_PORT_EXPLAIN'              => 'Port sur lequel le démon de recherche Sphinx (« searchd ») écoute. Si vous laissez ce champ vide, le port par défaut de l’API de Sphinx (9312) sera utilisé.',
	...
	'FULLTEXT_SPHINX_CONFIG_FILE_EXPLAIN'       => 'Le contenu du fichier de configuration de Sphinx. Ce contenu doit être retranscrit dans le fichier « sphinx.conf » utilisé par le démon de recherche Sphinx. Remplacez les marques substitutives « [dbuser] » et « [dbpassword] » par vos identifiants de base de données.',
	...
	'MAX_SEARCH_CHARS_EXPLAIN'        => 'Les mots ne dépassant pas ce nombre de caractères seront indexés.',
	...
	'MIN_SEARCH_CHARS_EXPLAIN'        => 'Les mots contenant au moins ce nombre de caractères seront indexés.',
	'MIN_SEARCH_AUTHOR_CHARS'         => 'Nombre minimal de caractères des noms d’auteur',
	'MIN_SEARCH_AUTHOR_CHARS_EXPLAIN' => 'Le nombre minimal de caractères que les utilisateurs devront saisir lorsqu’ils effectuent une recherche d’auteurs en utilisant un astérisque « * » comme métacaractère passe-partout. Si les noms d’auteur sont plus courts que la valeur saisie dans ce champ, les utilisateurs devront saisir les noms d’utilisateur complets.',
	...
	'SEARCH_INDEX_CREATE_REDIRECT'      => [
		1 => 'Tous les messages allant jusqu’au message dont l’identifiant est %2$d sont désormais indexés, dont %1$d message pour cette étape.',
		2 => 'Tous les messages allant jusqu’au message dont l’identifiant est %2$d sont désormais indexés, dont %1$d messages pour cette étape.',
	],
	...
	'SEARCH_INDEX_DELETE_REDIRECT'      => [
		1 => 'Tous les messages allant jusqu’au message dont l’identifiant est %2$d sont désormais supprimés de l’index de recherche, dont %1$d message pour cette étape.',
		2 => 'Tous les messages allant jusqu’au message dont l’identifiant est %2$d sont désormais supprimés de l’index de recherche, dont %1$d messages pour cette étape.',
	],
	...
	'SEARCH_STORE_RESULTS'              => 'Durée de mise en cache des résultats de recherche',
	...
	'TOTAL_MATCHES' => 'Nombre total de relations entre mots et messages indexées',
