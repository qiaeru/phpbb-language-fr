...
$lang = array_merge($lang, [
	...
	'SITE_HOME_URL_EXPLAIN'        => 'Si vous saisissez un lien, il sera inséré dans les liens de navigation de votre forum et remplacera le lien présent sur le logo du forum, redirigeant par défaut les utilisateurs sur l’accueil du forum, par la destination souhaitée. Veuillez saisir un lien absolu, tel que « https://www.phpbb.com ».',
...
$lang = array_merge($lang, [
	...
	'COOKIE_DOMAIN_EXPLAIN'  => 'Dans la plupart des cas, le domaine du cookie est facultatif. Laissez ce champ vide si vous avez des doutes.<br /><br />Cependant, dans le cas où votre forum est intégré à un autre logiciel ou est hébergé sur plusieurs domaines, vous devrez alors déterminer le domaine du cookie. Si vous avez quelque chose tel que « exemple.com », « forums.exemple.com », « forums.exemple.com » ou encore « blog.exemple.com », supprimez les sous-domaines pour ne conserver que le domaine commun, tel que « exemple.com ». Il vous suffit alors d’ajouter un point avant ce domaine commun, et le domaine du cookie ressemblera alors à .exemple.com (notez le point au début).',
...
$lang = array_merge($lang, [
	...
	'LDAP_DN_EXPLAIN'              => 'Le nom absolu menant aux informations des utilisateurs, telles que « o=MaCompagnie,c=FR ».',
	...
	'LDAP_USER'                    => 'Utilisateur « dn » LDAP',
	'LDAP_USER_EXPLAIN'            => 'Si vous souhaitez utiliser une connexion anonyme, ne remplissez pas ce champ. Dans le cas contraire, si cela a été renseigné dans phpBB, vous pouvez utiliser le nom absolu que vous avez spécifié lors de vos tentatives de connexion pour retrouver l’utilisateur correct, tel que « uid=Nom,ou=MonUnité,o=MaCompagnie,c=FR ». Cette information est obligatoire pour les serveurs aux répertoires dits actifs.',
...
$lang = array_merge($lang, [
	...
	'ICONS_PATH_EXPLAIN'                  => 'Le chemin relatif à la racine du répertoire de votre forum, tel que <samp>images/icons ».',
...
$lang = array_merge($lang, [
	...
	'JAB_GTALK_NOTE'                => 'Veuillez noter que GTalk ne fonctionnera pas car la fonction « dns_get_record » est introuvable. Cette fonction n’est pas implémentée dans PHP4, sur les plates-formes Windows et sur les systèmes basés sous BSD, incluant Mac OS.',
