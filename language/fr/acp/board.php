...
<<<<<<< HEAD
	...
	'OVERRIDE_STYLE_EXPLAIN'       => 'Le style des utilisateurs et des invités sera remplacé par celui qui a été sélectionné dans l’option « Style par défaut ».',
...
>>>>>>> 3.2.x
	...
	'JAB_VERIFY_PEER_EXPLAIN'       => 'Vérifie le certificat SSL utilisé par le serveur Jabber. <em><strong>Attention :</strong> les connexions aux pairs avec des certificats SSL qui n’ont pas été vérifiés peuvent avoir des répercutions sur la sécurité.</em>',
	'JAB_VERIFY_PEER_NAME'          => 'Vérifier le nom de pair Jabber',
	'JAB_VERIFY_PEER_NAME_EXPLAIN'  => 'Vérifie le nom de pair des serveurs Jabber utilisant des connexions SSL et TLS. <em><strong>Attention :</strong> les connexions à des pairs qui n’ont pas été vérifiés peuvent avoir des répercutions sur la sécurité.</em>',
]);
