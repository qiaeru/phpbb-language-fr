...
$lang = array_merge($lang, [
	...
	'BOARD_INDEX_TEXT_EXPLAIN'     => 'Ce texte sera affiché comme accueil du forum dans le chemin de navigation du forum. Si aucun texte n’est spécifié, « <em>Accueil du forum</em> » sera affiché par défaut.',
	'BOARD_STYLE'                  => 'Style du forum',
	'CUSTOM_DATEFORMAT'            => 'Personnaliser…',
	'DEFAULT_DATE_FORMAT'          => 'Format de date',
	'DEFAULT_DATE_FORMAT_EXPLAIN'  => 'Le format de date est similaire à celui qui est utilisé par la fonction <code>date</code> de PHP.',
	'DEFAULT_LANGUAGE'             => 'Langue par défaut',
	'DEFAULT_STYLE'                => 'Style par défaut',
	'DEFAULT_STYLE_EXPLAIN'        => 'Le style par défaut affiché aux nouveaux utilisateurs.',
	...
	'DISPLAY_LAST_SUBJECT_EXPLAIN' => 'Le sujet du dernier message qui a été publié dans un forum sera affiché dans la liste de ce forum sous forme de lien redirigeant vers le message. Les sujets publiés dans les forums qui sont protégés par un mot de passe et les forums qui sont en lecture seule ne sont pas affichés.',
	'GUEST_STYLE'                  => 'Styles des invités',
	'GUEST_STYLE_EXPLAIN'          => 'Le style affiché aux invités.',
	'OVERRIDE_STYLE'               => 'Écraser le style des utilisateurs',
	'OVERRIDE_STYLE_EXPLAIN'       => 'Le style des utilisateurs (et des invités) sera remplacé par celui qui a été sélectionné sous « <em>Style par défaut</em> ».',
	'SITE_DESC'                    => 'Description du forum',
	'SITE_HOME_TEXT'               => 'Texte du lien vers le site internet principal',
	'SITE_HOME_TEXT_EXPLAIN'       => 'Ce texte sera affiché sous forme de lien redirigeant vers votre site internet et sera inséré dans les liens de navigation de votre forum. Si aucun texte n’est spécifié, « <em>Page d’accueil</em> » sera affiché par défaut.',
	'SITE_HOME_URL'                => 'Lien vers le site internet principal',
	'SITE_HOME_URL_EXPLAIN'        => 'Si vous saisissez un lien, il sera inséré dans les liens de navigation de votre forum et remplacera le lien présent sur le logo du forum, redirigeant par défaut les utilisateurs sur l’accueil du forum, par la destination souhaitée. Veuillez saisir un lien absolu, tel que <samp>https://www.phpbb.com</samp>.',
...
$lang = array_merge($lang, [
	...
	'ALLOW_SIG_FLASH'           => 'Autoriser la balise BBCode <code>[FLASH]</code> dans les signatures',
	'ALLOW_SIG_IMG'             => 'Autoriser la balise BBCode <code>[IMG]</code> dans les signatures',
	'ALLOW_SIG_LINKS'           => 'Autoriser les liens dans les signatures',
	'ALLOW_SIG_LINKS_EXPLAIN'   => 'Si cette option est désactivée, l’utilisation de la balise BBCode <code>[URL]</code> et la transformation automatique de textes sous forme de liens sera désactivée.',
...
$lang = array_merge($lang, [
	...
	'ALLOW_FLASH_PM'             => 'Autoriser la balise BBCode <code>[FLASH]</code>',
	...
	'ALLOW_IMG_PM'               => 'Autoriser la balise BBCode <code>[IMG]</code>',
...
$lang = array_merge($lang, [
	...
	'ALLOW_POST_LINKS_EXPLAIN'      => 'Si vous n’autorisez pas cette fonctionnalité, l’utilisation de la balise BBCode <code>[URL]</code> et la transformation automatique de textes sous forme de liens sera désactivée.',
	...
	'ALLOW_POST_FLASH'              => 'Autoriser la balise BBCode <code>[FLASH]</code> dans les messages',
	'ALLOW_POST_FLASH_EXPLAIN'      => 'Si vous n’autorisez pas cette fonctionnalité, l’utilisation de la balise BBCode <code>[FLASH]</code> sera désactivée dans tous les messages. Dans le cas contraire, vous pourrez déterminer depuis le système de permissions quels utilisateurs pourront, ou non, utiliser cette balise.',
	...
	'DISPLAY_LAST_EDITED_EXPLAIN' => 'La date de la dernière modification des messages sera affichée sur ces derniers.',
	'EDIT_TIME'                   => 'Limite de la durée de modification',
	'EDIT_TIME_EXPLAIN'           => 'Limite la durée de modification des messages publiés. Réglez cette valeur sur 0 afin de ne pas limiter cette durée.',
...
$lang = array_merge($lang, [
	...
	'NEW_MEMBER_POST_LIMIT_EXPLAIN'    => 'Les nouveaux membres seront ajoutés au groupe des <em>Utilisateurs nouvellement inscrits</em> jusqu’à ce qu’ils atteignent ce nombre de messages. Vous pouvez utiliser ce groupe afin d’empêcher ces membres à utiliser la messagerie privée ou de contrôler leurs messages. <strong>Réglez cette valeur sur 0 afin de désactiver cette fonctionnalité.</strong>',
...
$lang = array_merge($lang, [
	...
	'ACP_FEED_ENABLE_EXPLAIN' => 'Active ou désactive les flux ATOM dans la totalité du forum. Si cette option est désactivée, tous les flux seront désactivés, sans prendre en compte les paramètres ci-dessous.',
...
// Server Settings
$lang = array_merge($lang, [
	'ACP_SERVER_SETTINGS_EXPLAIN' => 'Depuis cette page, vous pouvez configurer les paramètres relatifs au serveur et au domaine. Veuillez vous assurer de la validité des données présentes ci-dessous car vos courriels pourraient contenir des informations erronées si des données invalides étaient présentes. Lorsque vous saisissez le nom de domaine, n’oubliez pas d’inclure le protocole, tel que « <em>http://</em> » ou « <em>https://</em> ». Ne modifiez le port que si votre serveur fonctionne sous un port différent dont vous avez connaissance, mais sachez néanmoins que le port 80 convient dans la plupart des cas.',
	...
	'MOD_REWRITE_ENABLE_EXPLAIN'          => 'Si cette option est activée, les liens contenant « <em>app.php</em> » seront réécrits afin de supprimer le nom du fichier (par exemple, « <em>app.php/foo</em> » deviendra « <em>/foo</em> »). <strong>Le module mod_rewrite du serveur Apache doit être activé afin que la réécriture fonctionne correctement. Si cette option est activée alors que mod_rewrite n’est pas activé, les liens de votre forum peuvent ne plus fonctionner.</strong>',
...
$lang = array_merge($lang, [
	...
	'ALL'                                  => 'Tout',
	'ALLOW_AUTOLOGIN'                      => 'Activer la fonctionnalité « <em>Se souvenir de moi</em> »',
	'ALLOW_AUTOLOGIN_EXPLAIN'              => 'Les utilisateurs pourront se connecter automatiquement lors de leurs visites sur le forum.',
	'ALLOW_PASSWORD_RESET'                 => 'Autoriser la réinitialisation des mots de passe (« <em>J’ai oublié mon mot de passe</em> »)',
	'ALLOW_PASSWORD_RESET_EXPLAIN'         => 'Les utilisateurs pourront utiliser le lien « <em>J’ai oublié mon mot de passe</em> » situé sur la page de connexion afin de réinitialiser leur mot de passe et recommencer à se connecter sur le forum. Si vous utilisez un système d’authentification externe, vous devriez désactiver cette fonctionnalité.',
...
$lang = array_merge($lang, [
	...
	'BOARD_EMAIL_FORM'               => 'Activer l’envoi de courriels depuis le forum',
	...
	'EMAIL_FUNCTION_NAME_EXPLAIN'    => 'Le nom de la fonction PHP utilisée par la messagerie électronique afin d’envoyer des courriels.',
	...
	'ENABLE_EMAIL'                   => 'Activer l’envoi de courriels à partir du forum',
	'ENABLE_EMAIL_EXPLAIN'           => 'Si cette option est désactivée, aucun courriel ne pourra être envoyé à partir du forum. <em>Veuillez noter que cette option doit être activée afin que l’activation par l’utilisateur ou par l’administrateur soit fonctionnelle. Si vous utilisez actuellement l’activation « <em>Par l’utilisateur</em> » ou « <em>Par l’administrateur</em> » et que vous n’activez pas cette option, l’inscription sera désactivée.</em>',
	...
	'SMTP_ALLOW_SELF_SIGNED_EXPLAIN' => 'Autoriser les connexions au serveur SMTP avec un certificat SSL auto-signé. <em><strong>Attention :</strong> les certificats SSL auto-signés peuvent avoir des implications sur la sécurité.</em>',
	...
	'SMTP_SERVER_EXPLAIN'            => 'Veuillez noter que vous devez renseigner le protocole utilisé par le serveur. Si vous utilisez SSL, cela ressemblera à « <em>ssl://exemple.com</em> ».',
	...
	'SMTP_VERIFY_PEER_EXPLAIN'       => 'Force la vérification du certificat SSL utilisé par les serveurs SMTP. <em><strong>Attention :</strong> la connexion de pairs avec des certificats SSL qui ne sont pas vérifiés peut avoir des implications sur la sécurité.</em>',
...
$lang = array_merge($lang, [
	...
	'JAB_ALLOW_SELF_SIGNED_EXPLAIN' => 'Autorise les connexions au serveur Jaber avec des certificats SSL auto-signés. <em><strong>Attention :</strong> les certificats SSL auto-signés peuvent avoir un impact sur la sécurité.</em>',
	...
	'JAB_PACKAGE_SIZE'              => 'Taille du paquet Jabber package size',
	...
	'JAB_VERIFY_PEER_EXPLAIN'       => 'Vérifie le certificat SSL utilisé par le serveur Jabber. <em><strong>Attention :</strong> les connexions aux pairs avec des certificats SSL qui n’ont pas été vérifiés peuvent avoir un impact sur la sécurité.</em>',
	'JAB_VERIFY_PEER_NAME'          => 'Vérifier le nom de pair Jabber',
	'JAB_VERIFY_PEER_NAME_EXPLAIN'  => 'Vérifie le nom de pair des serveurs Jabber utilisant des connexions SSL et TLS. <em><strong>Attention :</strong> les connexions à des pairs qui n’ont pas été vérifiés peuvent avoir un impact sur la sécurité.</em>',
]);
