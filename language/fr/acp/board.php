...
$lang = array_merge($lang, [
	...
	'ALLOW_BIRTHDAYS_EXPLAIN'   => 'Les utilisateurs pourront saisir leur date de naissance afin que leur âge soit affiché sur leur profil. Notez que la liste des anniversaires affichée sur l’accueil du forum ne dépend pas de ce paramètre.',
...
$lang = array_merge($lang, [
	...
	'HOT_THRESHOLD_EXPLAIN'       => 'Le nombre de messages par sujet à atteindre afin qu’un sujet soit considéré comme populaire. Réglez cette valeur sur « 0 » pour désactiver ce comportement.',
...
$lang = array_merge($lang, [
	...
	'MAX_SIG_FONT_SIZE_EXPLAIN'  => 'La taille maximale de la police que les utilisateurs pourront spécifier dans leur signature. Réglez cette valeur sur « 0 » pour ne pas limiter la taille de la police.',
...
$lang = array_merge($lang, [
	...
	'CAPTCHA_GD_FONTS_EXPLAIN'            => 'Contrôle le nombre de formes de lettres utilisées. Vous pouvez n’utiliser que les formes par défaut ou en ajouter de nouvelles. Vous pouvez aussi ajouter des lettres en minuscule.',
...
$lang = array_merge($lang, [
	...
	'MOD_REWRITE_ENABLE_EXPLAIN'          => 'Si cette option est activée, les liens contenant « app.php » seront réécrits pour supprimer le nom du fichier (par exemple, « app.php/foo » deviendra « /foo »). Le module « mod_rewrite » du serveur Apache doit être activé afin que la réécriture fonctionne correctement. Si cette option est activée alors que « mod_rewrite » n’est pas activé, les liens de votre forum peuvent ne plus fonctionner.',
	'MOD_REWRITE_DISABLED'                => 'Le module « mod_rewrite » de votre serveur Apache est désactivé. Pour activer cette fonctionnalité, vous devez activer ce module ou demander à votre hébergeur internet de le faire.',
	'MOD_REWRITE_INFORMATION_UNAVAILABLE' => 'Nous sommes dans l’incapacité de déterminer si votre serveur est compatible avec cette fonctionnalité. Vous pouvez essayer d’activer la réécriture des liens, mais si votre serveur n’est pas compatible avec cette dernière, les chemins générés par le forum peuvent ne plus fonctionner correctement. Contactez votre hébergeur internet pour lui demander si vous pouvez activer en toute sécurité cette fonctionnalité.',
...
$lang = array_merge($lang, [
	...
	'BOARD_HIDE_EMAILS_EXPLAIN'      => 'Les adresses e-mail peuvent être masquées afin qu’elles demeurent confidentielles.',
	...
	'EMAIL_MAX_CHUNK_SIZE_EXPLAIN'   => 'Si possible, prenez soin de ne pas dépasser le nombre maximal de destinataires par e-mail que votre serveur de messagerie peut supporter.',
	...
	'ENABLE_EMAIL_EXPLAIN'           => 'Si cette option est désactivée, aucun e-mail ne pourra être envoyé à partir du forum. Notez que cette option doit être activée afin que l’activation par l’utilisateur ou par un administrateur soit fonctionnelle. Si vous utilisez actuellement l’activation par l’utilisateur ou par un administrateur et que vous n’activez pas cette option, les inscriptions seront désactivées.',
...
$lang = array_merge($lang, [
	...
	'JAB_GTALK_NOTE'                => 'Notez que GTalk ne fonctionnera pas car la fonction « dns_get_record » est introuvable. Cette fonction n’est pas implémentée dans PHP 4, sur les plates-formes Windows et sur les systèmes basés sous BSD, incluant Mac OS.',
