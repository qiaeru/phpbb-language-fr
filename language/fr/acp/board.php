...
$lang = array_merge($lang, [
	...
	'DISPLAY_LAST_SUBJECT_EXPLAIN'     => 'Le sujet du dernier message publié dans un forum est affiché dans la liste des forums sous forme de lien vers ce message. Les sujets des forums protégés par mot de passe ou en lecture seule ne sont pas affichés.',
	...
	'WARNINGS_EXPIRE_EXPLAIN'          => 'Le nombre de jours qui s’écouleront avant qu’un avertissement n’expire automatiquement. Réglez cette valeur sur « 0 » pour ne pas faire expirer les avertissements dans le temps.',
]);
...
$lang = array_merge($lang, [
	...
	'BOXES_LIMIT_EXPLAIN'        => 'Si leur boîte est pleine, les utilisateurs ne pourront pas recevoir davantage de messages privés que la valeur indiquée dans ce champ. Réglez cette valeur sur « 0 » pour ne pas limiter le nombre de messages privés par boîte.',
	'BOXES_MAX'                  => 'Nombre maximal de boîtes de messages privés',
	'BOXES_MAX_EXPLAIN'          => 'Nombre maximal de boîtes de messages privés que les utilisateurs peuvent créer et utiliser.',
	...
	'FULL_FOLDER_ACTION_EXPLAIN' => 'Opération effectuée par défaut quand la boîte d’un utilisateur est pleine et que l’opération qu’il a choisie est impossible. Exception : pour la boîte des messages envoyés, les plus anciens sont automatiquement supprimés par défaut.',
...
$lang = array_merge($lang, [
	...
	'ALLOWED_SCHEMES_LINKS_EXPLAIN' => 'Les utilisateurs ne peuvent publier que les liens sans schéma d’URL ou les liens avec des schémas d’URL autorisés dans ce champ, en les séparant par une virgule.',
	...
	'MAX_POST_IMG_WIDTH_EXPLAIN'  => 'La largeur maximale des fichiers Flash dans les messages et les messages privés. Réglez cette valeur sur « 0 » pour ne limiter la largeur des fichiers Flash.',
...
$lang = array_merge($lang, [
	...
	'ACC_ACTIVATION_EXPLAIN'           => 'Détermine quels utilisateurs bénéficieront d’un accès immédiat au forum ou si une confirmation leur sera demandée. Vous pouvez également désactiver entièrement les nouvelles inscriptions. Notez que l’option « Envoi des e-mails depuis le forum » doit être activée pour être en mesure de pouvoir utiliser l’activation par un administrateur ou par l’utilisateur lui-même.',
...
//	'ACC_USER_ADMIN'			  => 'Par l’utilisateur et un administrateur',
	...
	'PASSWORD_LENGTH_EXPLAIN'     => 'Nombre minimal et maximal de caractères pour les mots de passe. Notez qu’il n’y a pas de limite supérieure.',
	'REG_LIMIT'                   => 'Nombre maximal de tentatives d’inscription par session',
	'REG_LIMIT_EXPLAIN'           => 'Nombre maximal de tentatives d’inscription par session avant qu’elle expire et exige la saisie d’un code anti-spam.',
...
$lang = array_merge($lang, [
	...
	'ACP_FEED_EXCLUDE_ID_EXPLAIN'      => 'Le contenu de ces forums ne sera pas affiché dans les flux. Pour extraire les données de tous les forums, ne sélectionnez aucun forum.<br>Vous pouvez sélectionner ou désélectionner plusieurs forums en maintenant appuyé la touche « CTRL » du clavier de votre ordinateur et en cliquant.',
]);

// Visual Confirmation Settings
$lang = array_merge($lang, [
	'ACP_VC_SETTINGS_EXPLAIN'             => 'Depuis cette page, vous pouvez sélectionner et configurer toutes les extensions qui permettent de se prémunir contre les spam (publications automatiques). Ces extensions demandent en général aux utilisateurs de résoudre un CAPTCHA, qui est un outil permettant de différencier les humains des robots.',
	'ACP_VC_EXT_GET_MORE'                 => 'Vous pouvez obtenir d’autres extensions contre les spam, qui seront probablement plus efficaces, en visitant <a href="https://www.phpbb.com/go/anti-spam-ext">la base de données des extensions</a> (en anglais). Pour plus d’informations concernant la prévention des spam sur votre forum, visitez <a href="https://www.phpbb.com/go/anti-spam">la base de connaissances</a> (en anglais).',
	...
	'CAPTCHA_GD_EXPLAIN'                  => 'Utilise la bibliothèque graphique « GD » pour rendre l’image plus difficilement déchiffrable, pour éviter les spam (publications automatiques).',
	...
	'VISUAL_CONFIRM_POST'            => 'Activer les mesures de lutte contre les spam aux invités',
	'VISUAL_CONFIRM_POST_EXPLAIN'    => 'Les utilisateurs qui ne sont pas connectés seront invités à compléter des mesures pour éviter les spam (publications automatiques).',
	'VISUAL_CONFIRM_REG'             => 'Activer les mesures de lutte contre les spam lors des inscriptions',
	'VISUAL_CONFIRM_REG_EXPLAIN'     => 'Les utilisateurs seront invités à compléter des mesures pour éviter les spam (publications automatiques) lors de leurs inscriptions.',
	'VISUAL_CONFIRM_REFRESH'         => 'Autoriser les utilisateurs à rafraîchir les mesures de lutte contre les spam',
	'VISUAL_CONFIRM_REFRESH_EXPLAIN' => 'Les utilisateurs, s’ils sont incapables de déchiffrer la mesure actuelle, pourront demander une nouvelle mesure de lutte contre les spam (publications automatiques). Certaines extensions peuvent ne pas prendre en charge cette fonctionnalité.',
]);
...
$lang = array_merge($lang, [
	...
	'AUTH_PROVIDER_OAUTH_EXPLAIN'               => 'Chaque fournisseur de service OAuth doit être renseigné par une clé et un secret unique pour pouvoir se faire authentifier par le serveur externe. Ces données sont renseignées par le service OAuth lors de l’inscription de votre site web à leurs services et doivent être saisies telles quelles.<br>Chaque service qui n’est pas renseigné de ces deux données ne sera pas accessible aux utilisateurs du forum. Notez que les utilisateurs pourront toujours s’inscrire et se connecter en utilisant l’extension d’authentification de la base de données.',
	'AUTH_PROVIDER_OAUTH_KEY'                   => 'Clé',
	'AUTH_PROVIDER_OAUTH_TITLE'                 => 'OAuth',
	'AUTH_PROVIDER_OAUTH_SECRET'                => 'Secret',

	'APACHE_SETUP_BEFORE_USE' => 'Vous devez configurer l’authentification par Apache avant de pouvoir faire fonctionner phpBB sous cette méthode d’authentification. Le nom d’utilisateur que vous utilisez pour vous authentifier par Apache doit être identique à votre nom d’utilisateur sur le forum. L’authentification par Apache ne doit être utilisée qu’avec « mod_php » (qui ne doit pas être avec une version CGI).',
	...
	'LDAP_PASSWORD_EXPLAIN'        => 'Si vous souhaitez utiliser une connexion anonyme, ne remplissez pas ce champ. Dans le cas contraire, vous pouvez indiquer le mot de passe lié à l’utilisateur ci-dessus. Cette information est obligatoire pour les serveurs aux répertoires dits actifs.<br><em><strong>Attention :</strong> ce mot de passe sera archivé en texte brut dans la base de données et sera donc visible à tous ceux qui ont accès à votre base de données et à cette page de configuration.</em>',
	'LDAP_PORT'                    => 'Port du serveur LDAP',
	'LDAP_PORT_EXPLAIN'            => 'Si vous le souhaitez, vous pouvez saisir un port différent au port 389 utilisé par défaut.',
	...
	'LDAP_USER_EXPLAIN'            => 'Si vous souhaitez utiliser une connexion anonyme, ne remplissez pas ce champ. Dans le cas contraire, si cela a été renseigné dans phpBB, vous pouvez utiliser le nom absolu lors de vos tentatives de connexion pour retrouver le bon utilisateur, tel que « uid=Nom,ou=MonUnité,o=MaCompagnie,c=FR ». Cette information est obligatoire pour les serveurs aux répertoires dits actifs.',
...
$lang = array_merge($lang, [
	...
	'MOD_REWRITE_INFORMATION_UNAVAILABLE' => 'Nous sommes dans l’incapacité de déterminer si votre serveur est compatible avec cette fonctionnalité. Vous pouvez essayer d’activer la réécriture des liens, mais si votre serveur n’est pas compatible avec cette dernière, les chemins générés par le forum peuvent ne plus fonctionner correctement. Contactez votre hébergeur web pour lui demander si vous pouvez activer en toute sécurité cette fonctionnalité.',
...
$lang = array_merge($lang, [
	...
	'FORCE_PASS_CHANGE_EXPLAIN'            => 'Les utilisateurs devront modifier leur mot de passe après que le nombre de jours saisi dans ce champ ne soit écoulé. Réglez cette valeur sur « 0 » pour désactiver ce comportement.',
	...
	'REFERRER_VALID_EXPLAIN'               => 'Si cette option est activée, le référant des requêtes « POST » sera vérifié et pourra servir à valider l’hôte et le chemin du forum. Si votre forum est accessible sur plusieurs domaines ou utilise des connexions externes, vous ne devez pas autoriser le référant à valider le chemin pour éviter tout conflit.',
...
$lang = array_merge($lang, [
	...
	'BOARD_EMAIL_FORM'               => 'Envoi des e-mails depuis le forum',
	...
	'CONTACT_EMAIL_EXPLAIN'          => 'Cette adresse sera utilisée lorsqu’un contact particulier est nécessaire, comme en cas de message indésirable, d’erreur, etc. Elle sera toujours utilisée comme l’adresse du chemin de l’envoi et considérée comme celle du destinataire dans les e-mails.',
	...
	'EMAIL_FORCE_SENDER_EXPLAIN'     => 'L’adresse e-mail d’expédition utilisera la fonction « Return-Path » au lieu d’utiliser l’utilisateur et le nom d’hôte local du serveur. Notez que ce paramètre est ignoré si vous utilisez le protocole SMTP.<br><em><strong>Attention :</strong> vous devez vous assurer que le serveur soit ajouté en tant qu’utilisateur de confiance dans la configuration du service d’envoi de e-mails.</em>',
	'EMAIL_PACKAGE_SIZE'             => 'Nombre de e-mails envoyés en une seule fois',
	'EMAIL_PACKAGE_SIZE_EXPLAIN'     => 'Le nombre de e-mails envoyés en une seule fois. Ce paramètre est appliqué à la file d’attente de la messagerie e-mail interne. Si vous rencontrez des difficultés lors de l’envoi de e-mails alors que cette option est activée, nous vous conseillons de régler cette valeur sur « 0 ».',
	...
	'SMTP_SERVER_EXPLAIN'            => 'Ne renseignez pas de protocole (« ssl:// » ou « tls:// ») mis à part si votre hébergeur de e-mails vous indique de le faire.',
