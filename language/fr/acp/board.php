...
$lang = array_merge($lang, [
	...
	'ADMIN_EMAIL'                    => 'Adresse de courriel de provenance',
	'ADMIN_EMAIL_EXPLAIN'            => 'Cette adresse sera utilisée comme l’adresse de provenance de tous les courriels. Cela correspond à l’adresse de courriel du contact technique. Elle sera toujours utilisée comme l’adresse de l’expéditeur dans les courriels.',
	...
	'EMAIL_FORCE_SENDER'             => 'Forcer l’adresse de courriel de provenance',
	'EMAIL_FORCE_SENDER_EXPLAIN'     => 'L’adresse de courriel de provenance utilisera la fonction « Return-Path » au lieu d’utiliser l’utilisateur et le nom d’hôte local du serveur. Veuillez noter que ce paramètre est ignoré si vous utilisez le protocole SMTP.<br><em><strong>Attention :</strong> vous devez vous assurer que le serveur soit ajouté en tant qu’utilisateur de confiance dans la configuration du service d’envoi de courriels.</em>',
