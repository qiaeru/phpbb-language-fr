...
$lang = array_merge($lang, [
	...
	'AVATAR_STORAGE_PATH_EXPLAIN' => 'Le chemin relatif à la racine du répertoire de votre forum, tel que « images/avatars/upload ».<br>Le transfert des avatars ne sera pas disponible si le répertoire indiqué est en lecture seule.<br>Pour des raisons de sécurité, les deux points, tels que « ../ », seront retirés du chemin.',
...
//	'ACC_USER_ADMIN'			  => 'Par l’utilisateur et un administrateur',
	...
	'MAX_CHARS'                   => 'max',
	'MIN_CHARS'                   => 'min',
	'NO_AUTH_PLUGIN'              => 'Aucun extension d’authentification n’a été trouvé.',
...
$lang = array_merge($lang, [
	'ACP_VC_SETTINGS_EXPLAIN'             => 'Depuis cette page, vous pouvez sélectionner et configurer tous les extensions qui permettent de se prémunir contre les spam (publications automatiques). Ces extensions demandent en général aux utilisateur de résoudre un CAPTCHA, qui est un outil permettant de différencier les humains aux robots.',
	...
	'CAPTCHA_UNAVAILABLE'                 => 'Le extension ne peut pas être sélectionné tant que ses prérequis ne sont pas respectés.',
	...
	'CAPTCHA_PREVIEW_EXPLAIN'             => 'Le extension tel qu’il ressemblera lors de son utilisation.',

	'CAPTCHA_SELECT'            => 'Extensions installés',
	'CAPTCHA_SELECT_EXPLAIN'    => 'La liste déroulante contient les extensions reconnus par le forum. Les éléments grisés correspondent aux extensions qui ne sont pas encore disponibles et qui peuvent nécessiter une configuration avant leur utilisation.',
	'CAPTCHA_CONFIGURE'         => 'Configurer les extensions',
	'CAPTCHA_CONFIGURE_EXPLAIN' => 'Vous permet de configurer le extension sélectionné dans la liste déroulante.',
	'CONFIGURE'                 => 'Configurer',
	'CAPTCHA_NO_OPTIONS'        => 'Ce extension n’a aucune option de configuration.',
	...
	'VISUAL_CONFIRM_REFRESH_EXPLAIN' => 'Les utilisateurs, s’ils sont incapables de déchiffrer la mesure actuelle, pourront demander une nouvelle mesure de lutte contre les spam (publications automatiques). Certains extensions peuvent ne pas prendre en charge cette fonctionnalité.',
]);
...
$lang = array_merge($lang, [
	...
	'LOAD_USER_ACTIVITY_LIMIT_EXPLAIN'      => 'Les forums et les sujets où les utilisateurs sont actifs ne seront pas affichés aux utilisateurs qui ont publiés plus que ce nombre de messages. Réglez cette valeur sur « 0 » pour désactiver ce comportement.',
