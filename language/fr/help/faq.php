...
$lang = array_merge($lang, [
	...
	'HELP_FAQ_FORMATTING_HTML_ANSWER'              => 'Non. Le code HTML publié sur ce forum n’est pas interprété. La plupart des mises en forme HTML peuvent être obtenues avec le BBCode.',
	...
	'HELP_FAQ_ISSUES_ADMIN_ANSWER'         => 'Tous les utilisateurs du forum peuvent utiliser le formulaire « Nous contacter » si cette fonctionnalité a été activée par les administrateurs du forum.<br>Les membres du forum peuvent également utiliser le lien « L’équipe ».',
	...
	'HELP_FAQ_LOGIN_COPPA_ANSWER'                  => 'La COPPA (Children’s Online Privacy Protection Act de 1998) est une loi américaine qui impose aux sites pouvant collecter des informations sur des mineurs de moins de 13 ans d’obtenir un consentement écrit de leurs parents ou tuteurs légaux. Si vous ignorez si cette loi s’applique à vous ou au site sur lequel vous vous inscrivez, consultez un conseiller juridique. phpBB Limited et les propriétaires de ce forum n’apportent pas d’assistance juridique ; ne les contactez pas à ce sujet, sauf comme indiqué dans « Qui dois-je contacter à propos de problèmes d’abus ou de questions juridiques liés à ce forum ? ».',
	...
	'HELP_FAQ_POSTING_EDIT_DELETE_ANSWER'        => 'Sauf si vous êtes administrateur ou modérateur, vous ne pouvez modifier ou supprimer que vos propres messages. Cliquez sur le bouton dédié pour modifier l’un de vos messages, parfois dans une limite de temps après publication. Si quelqu’un a déjà répondu, un petit texte sous le message indique le nombre de modifications, avec date et heure. Ce texte n’apparaît pas pour les modifications effectuées par un modérateur ou un administrateur, qui peuvent toutefois indiquer, s’ils le jugent utile, la raison de leur modification. Les utilisateurs ordinaires ne peuvent pas supprimer un message ayant déjà reçu une réponse.',
	...
	'HELP_FAQ_POSTING_NO_ATTACHMENTS_ANSWER'     => 'Les permissions d’import de pièces jointes sont définies par forum, par groupe ou par utilisateur. Les administrateurs ont peut-être désactivé l’import dans le forum concerné, ou seuls certains groupes y sont autorisés. Pour plus d’informations, contactez un administrateur du forum.',
	'HELP_FAQ_POSTING_NO_ATTACHMENTS_QUESTION'   => 'Pourquoi ne puis-je pas importer de pièces jointes ?',
	...
	'HELP_FAQ_POSTING_QUEUE_ANSWER'              => 'Les administrateurs peuvent soumettre vos messages à validation avant publication. Il est aussi possible que vous ayez été placé dans un groupe dont les messages sont soumis à validation. Pour plus d’informations, contactez un administrateur du forum.',
	...
	'HELP_FAQ_SEARCH_BLANK_ANSWER'       => 'Votre recherche a renvoyé plus de résultats que le serveur ne peut en traiter. Utilisez la recherche avancée pour préciser vos termes et restreindre les forums concernés.',
	'HELP_FAQ_SEARCH_BLANK_QUESTION'     => 'Pourquoi ma recherche renvoie-t-elle une page blanche ?!',
	'HELP_FAQ_SEARCH_FORUM_ANSWER'       => 'Saisissez un terme dans la zone de recherche présente sur l’accueil du forum, les pages de forums ou de sujets. La recherche avancée est accessible via le lien « Recherche avancée » disponible sur toutes les pages. L’accès à la recherche dépend du style utilisé.',
	...
	'HELP_FAQ_USERSETTINGS_HIDE_ONLINE_ANSWER'       => 'Dans le panneau de contrôle utilisateur, section « Préférences du forum », activez l’option « Masquer ma présence ». Vous ne serez alors visible que des administrateurs, des modérateurs et de vous-même, et serez comptabilisé comme utilisateur invisible.',
